var allQuestions = [
    ...
    { id: 1, topic: "Introduction", q: "Consider the following statements regarding nucleic acids:<br>(i) DNA acts as genetic material in all living organisms.<br>(ii) RNA acts as genetic material in some viruses.<br>(iii) RNA can function as a catalytic molecule.<br>(iv) RNA always functions only as a messenger molecule.<br><br>Which of the above statements are <b>correct</b>?", options: ["(ii) and (iii) only", "(i) and (ii) only", "(i), (ii) and (iii)", "(ii), (iii) and (iv)"], correct: 0, explanation: "DNA acts as genetic material in most organisms, not all (some viruses use RNA) — so (i) is incorrect. Statement (iv) is wrong because RNA also acts as adapter, structural, and catalytic molecule. Statements (ii) and (iii) are correct per NCERT." },

    { id: 2, topic: "Introduction", q: "Which of the following roles is <b>NOT</b> attributed to RNA?", options: ["Genetic material in some viruses", "Genetic material in majority of organisms", "Catalytic molecule", "Adapter molecule"], correct: 1, explanation: "DNA is the genetic material in the majority of organisms. RNA serves as genetic material only in some viruses. RNA also functions as messenger, adapter, structural, and catalytic molecule." },
    ...
    { id: 6, topic: "Introduction", q: "The complete nucleotide sequence of the human genome has ushered in a new era of:", options: ["Genomics", "Proteomics", "Metabolomics", "Transcriptomics"], correct: 0, explanation: "NCERT states the determination of the complete nucleotide sequence of the human genome set in a new era of genomics." },
    ...
    { id: 10, topic: "Introduction", q: "The two types of nucleic acids found in living systems are:", options: ["DNA and mRNA", "DNA and tRNA", "rRNA and tRNA", "DNA and RNA"], correct: 3, explanation: "The two types are DNA (deoxyribonucleic acid) and RNA (ribonucleic acid). mRNA, tRNA, rRNA are subtypes of RNA." },

    { id: 11, topic: "Introduction", q: "Which of the following correctly represents the hierarchy of genetic information flow?", options: ["Replication (DNA) → Transcription (RNA) → Translation (Protein)", "DNA → Replication → Transcription → Translation", "DNA → RNA → Protein → Replication", "Translation → Transcription → Replication"], correct: 0, explanation: "Central dogma: DNA replicates → DNA makes RNA (transcription) → RNA makes protein (translation)." },
    ...
    { id: 14, topic: "Introduction", q: "Which of the following correctly describes the scope of genomics?", options: ["Study of protein structure and function", "Study of RNA transcription only", "Study of metabolic pathways only", "Study of complete nucleotide sequences of genomes"], correct: 3, explanation: "Genomics deals with the study of complete nucleotide sequences of genomes and their analysis." },

    { id: 15, topic: "Introduction", q: "Statement 1: DNA is the genetic material in all organisms without exception.<br>Statement 2: RNA functions as adapter, structural, catalytic and messenger molecule.", options: ["Only Statement 2 is correct", "Only Statement 1 is correct", "Both statements are correct", "Both statements are incorrect"], correct: 0, explanation: "Statement 1 is incorrect — DNA is genetic material in most organisms, but in some viruses, RNA is. Statement 2 is correct." },
    ...
    { id: 18, topic: "The DNA", q: "The genome size of <i>Escherichia coli</i> is:", options: ["5386 nucleotides", "48502 bp", "3.3 × 10⁹ bp", "4.6 × 10⁶ bp"], correct: 3, explanation: "E. coli genome = 4.6 × 10⁶ bp." },
    ...
    { id: 20, topic: "The DNA", q: "The length of DNA is usually defined as:", options: ["Number of nucleotides or base pairs", "Number of genes present", "Number of amino acids", "Molecular weight in Daltons"], correct: 0, explanation: "NCERT: the length of DNA is defined as the number of nucleotides or base pairs present in it." },

    { id: 21, topic: "The DNA", q: "Arrange in <b>increasing order</b> of genome size:<br>(i) φ×174 (ii) Human haploid (iii) E. coli (iv) Bacteriophage lambda", options: ["(i) < (iii) < (iv) < (ii)", "(i) < (iv) < (iii) < (ii)", "(iv) < (i) < (iii) < (ii)", "(ii) < (iii) < (iv) < (i)"], correct: 1, explanation: "φ×174 (5386 nt) < Lambda (48502 bp) < E. coli (4.6×10⁶ bp) < Human (3.3×10⁹ bp)." },
    ...
    { id: 23, topic: "The DNA", q: "Consider the following statements:<br>(i) DNA is a long polymer of deoxyribonucleotides.<br>(ii) The number of base pairs is characteristic of an organism.<br>(iii) Bacteriophage lambda has 5386 base pairs.<br>(iv) Human haploid DNA has 3.3 × 10⁹ bp.<br><br>Which statements are <b>correct</b>?", options: ["(i), (ii) and (iii)", "(i), (iii) and (iv)", "(ii), (iii) and (iv)", "(i), (ii) and (iv)"], correct: 3, explanation: "(iii) is incorrect — Lambda has 48502 bp, not 5386. φ×174 has 5386 nucleotides." },

    { id: 24, topic: "The DNA", q: "The genome of bacteriophage lambda consists of:", options: ["48502 base pairs", "5386 nucleotides", "4.6 × 10⁶ base pairs", "3.3 × 10⁹ base pairs"], correct: 0, explanation: "Bacteriophage lambda has 48502 bp (double-stranded DNA)." },
    ...
    { id: 26, topic: "The DNA", q: "The genome of E. coli is approximately how many times larger than bacteriophage lambda?", options: ["~10 times", "~700 times", "~95 times", "~1000 times"], correct: 2, explanation: "4.6×10⁶ / 48502 ≈ 95 times." },
    ...
    { id: 29, topic: "Polynucleotide Structure", q: "A nucleotide is formed by the linkage of:", options: ["Nitrogenous base + Pentose sugar + Phosphate group", "Nitrogenous base + Phosphate group", "Nitrogenous base + Pentose sugar", "Pentose sugar + Phosphate group"], correct: 0, explanation: "A nucleotide has three components — nitrogenous base, pentose sugar, and phosphate group." },

    { id: 30, topic: "Polynucleotide Structure", q: "Which of the following is a <b>purine</b> base?", options: ["Cytosine", "Guanine", "Uracil", "Thymine"], correct: 1, explanation: "Purines = Adenine and Guanine (double ring). Pyrimidines = Cytosine, Thymine, and Uracil (single ring)." },
    ...
    { id: 32, topic: "Polynucleotide Structure", q: "Thymine is also chemically known as:", options: ["5-methyl cytosine", "6-amino pyrimidine", "2-amino purine", "5-methyl uracil"], correct: 3, explanation: "Thymine = 5-methyl uracil. This is directly stated in NCERT." },

    { id: 33, topic: "Polynucleotide Structure", q: "The nitrogenous base is linked to the pentose sugar through:", options: ["N-glycosidic linkage at 1'C", "Phosphoester linkage at 5'C", "Phosphodiester linkage at 3'C", "Hydrogen bonding at 2'C"], correct: 0, explanation: "The base is linked to OH of 1'C of pentose sugar through an N-glycosidic linkage to form a nucleoside." },

    { id: 34, topic: "Polynucleotide Structure", q: "A nucleoside is formed by:", options: ["Base + Sugar + Phosphate", "Base + Sugar", "Sugar + Phosphate", "Base + Phosphate"], correct: 1, explanation: "Nucleoside = Nitrogenous base + Pentose sugar (linked by N-glycosidic bond). Nucleotide = Nucleoside + Phosphate." },
    ...
    { id: 36, topic: "Polynucleotide Structure", q: "Two nucleotides in a polynucleotide chain are linked through:", options: ["N-glycosidic linkage", "Phosphoester linkage", "Hydrogen bonding", "3'–5' phosphodiester linkage"], correct: 3, explanation: "Two nucleotides are linked through 3'–5' phosphodiester linkage." },
    ...
    { id: 39, topic: "Polynucleotide Structure", q: "The free phosphate group at 5'-end and free OH at 3'-end indicate:", options: ["No directionality", "Circular chain", "Polarity (5'→3')", "Branched chain"], correct: 2, explanation: "A polynucleotide chain has polarity — 5'-end has free phosphate, 3'-end has free OH group." },

    { id: 40, topic: "Polynucleotide Structure", q: "Which is the correct nucleoside of thymine in DNA?", options: ["Thymidine", "Deoxyuridine", "Uridine", "Deoxythymidine"], correct: 3, explanation: "NCERT lists deoxythymidine as the nucleoside of thymine in DNA." },

    { id: 41, topic: "Polynucleotide Structure", q: "What distinguishes RNA from DNA at the sugar level?", options: ["RNA has an additional –OH group at 2' position of ribose", "RNA has deoxyribose sugar", "RNA has an additional –OH group at 3' position", "RNA has a –CH₃ group at 2' position"], correct: 0, explanation: "NCERT: 'In RNA, every nucleotide has an additional –OH group at 2'-position in the ribose.'" },
    ...
    { id: 43, topic: "Polynucleotide Structure", q: "Which is <b>incorrect</b> regarding pyrimidine bases?", options: ["Cytosine is found in both DNA and RNA", "Guanine is a pyrimidine base", "Uracil is found only in RNA", "Thymine is found only in DNA"], correct: 1, explanation: "Guanine is a PURINE, not pyrimidine. Pyrimidines = Cytosine, Thymine, Uracil." },

    { id: 44, topic: "Polynucleotide Structure", q: "The nitrogenous bases in a polynucleotide chain are:", options: ["Part of the backbone", "Linked to the phosphate group", "Projecting from the backbone", "Between two sugar molecules"], correct: 2, explanation: "NCERT: 'The nitrogenous bases linked to sugar moiety project from the backbone.'" },

    { id: 45, topic: "Polynucleotide Structure", q: "Match: (i) Adenosine (ii) Deoxyadenosine (iii) Deoxyadenylic acid with (P) Nucleotide (Q) RNA nucleoside (R) DNA nucleoside", options: ["(i)–Q, (ii)–P, (iii)–R", "(i)–R, (ii)–Q, (iii)–P", "(i)–P, (ii)–Q, (iii)–R", "(i)–Q, (ii)–R, (iii)–P"], correct: 3, explanation: "Adenosine = RNA nucleoside (Q). Deoxyadenosine = DNA nucleoside (R). Deoxyadenylic acid = nucleotide (P)." },

    { id: 46, topic: "Polynucleotide Structure", q: "A dinucleotide is formed by linking two nucleotides through:", options: ["3'–5' phosphodiester bond", "Peptide bond", "N-glycosidic bond", "Hydrogen bond"], correct: 0, explanation: "NCERT: 'Two nucleotides are linked through 3'–5' phosphodiester linkage to form a dinucleotide.'" },
    ...
    { id: 48, topic: "Polynucleotide Structure", q: "Correct order of components from inside to outside in a DNA strand:", options: ["Phosphate → Sugar → Base", "Sugar → Base → Phosphate", "Base → Sugar → Phosphate", "Base → Phosphate → Sugar"], correct: 2, explanation: "Bases are inside (projecting inward), attached to sugar, connected to phosphate on the outside." },

    { id: 49, topic: "Polynucleotide Structure", q: "Statement 1: The pentose sugar in RNA is ribose.<br>Statement 2: DNA lacks an –OH group at 2' position compared to RNA.", options: ["Only Statement 1 is correct", "Only Statement 2 is correct", "Both statements are incorrect", "Both statements are correct"], correct: 3, explanation: "RNA has ribose (with 2'-OH), DNA has deoxyribose (lacking 2'-OH). Both are correct." },

    { id: 50, topic: "Polynucleotide Structure", q: "What differentiates a nucleoside from a nucleotide?", options: ["Nucleotide has phosphate linked at 5'C; nucleoside lacks it", "Nucleoside has phosphate; nucleotide does not", "Nucleoside has phosphodiester bond; nucleotide has glycosidic bond", "No difference"], correct: 0, explanation: "Nucleoside = base + sugar. Nucleotide = nucleoside + phosphate (at 5'C through phosphoester bond)." },

    { id: 51, topic: "Polynucleotide Structure", q: "Which carbon atoms of sugar are involved in phosphodiester linkage?", options: ["1'C and 4'C", "3'C and 5'C", "2'C and 5'C", "1'C and 5'C"], correct: 1, explanation: "The 3'–5' phosphodiester linkage involves 3'C of one sugar and 5'C of the adjacent sugar." },
    ...
    { id: 53, topic: "Polynucleotide Structure", q: "How many types of nitrogenous bases are present in DNA?", options: ["3", "5", "4", "2"], correct: 2, explanation: "DNA has 4 bases: Adenine, Guanine (purines) and Cytosine, Thymine (pyrimidines)." },

    { id: 54, topic: "Polynucleotide Structure", q: "Correct combination of pyrimidine bases in RNA:", options: ["Cytosine and Thymine", "Adenine and Guanine", "Uracil and Thymine", "Cytosine and Uracil"], correct: 3, explanation: "RNA contains Cytosine and Uracil as pyrimidines. Thymine is in DNA, not RNA." },

    { id: 55, topic: "Polynucleotide Structure", q: "Which nucleoside belongs to DNA?", options: ["Deoxycytidine", "Cytidine", "Uridine", "Adenosine"], correct: 0, explanation: "DNA nucleosides have 'deoxy-' prefix. Adenosine, cytidine, uridine are RNA nucleosides." },

    { id: 56, topic: "Polynucleotide Structure", q: "About a polynucleotide chain:<br>(i) Sugar-phosphate forms backbone<br>(ii) Bases project from backbone<br>(iii) Backbone = bases and sugars<br>(iv) Phosphodiester bonds link nucleotides<br><br>Which are correct?", options: ["(i), (ii) and (iii) only", "(i), (ii) and (iv) only", "(ii), (iii) and (iv) only", "All of the above"], correct: 1, explanation: "(iii) is incorrect — backbone = sugars + phosphates, NOT bases." },

    { id: 57, topic: "Polynucleotide Structure", q: "Correct sequence for polynucleotide formation:", options: ["Base + Sugar → Nucleotide → Nucleoside → Polynucleotide", "Phosphate + Sugar → Nucleoside + Base → Nucleotide → Polynucleotide", "Base + Sugar → Nucleoside + Phosphate → Nucleotide → Polynucleotide", "Base + Phosphate → Nucleoside + Sugar → Nucleotide → Polynucleotide"], correct: 2, explanation: "Base + Sugar → Nucleoside; + Phosphate → Nucleotide; Nucleotides linked → Polynucleotide." },

    { id: 58, topic: "Polynucleotide Structure", q: "The 3'-end of a polynucleotide chain has:", options: ["Free phosphate group at 5'C", "A capped methylated guanine", "A nitrogenous base", "Free –OH group at 3'C of sugar"], correct: 3, explanation: "NCERT: 'the sugar has a free OH of 3'C group which is referred to as 3'-end.'" },

    // ===== SET 4: DNA DOUBLE HELIX (Q59-Q88) =====
    { id: 59, topic: "DNA Double Helix", q: "DNA was first identified as an acidic substance in the nucleus by:", options: ["Friedrich Meischer", "Erwin Chargaff", "Watson and Crick", "Rosalind Franklin"], correct: 0, explanation: "Friedrich Meischer (1869) first identified DNA as an acidic substance and named it 'Nuclein'." },

    { id: 60, topic: "DNA Double Helix", q: "The double helix model of DNA was proposed based on:", options: ["Chargaff's rule alone", "X-ray diffraction data of Maurice Wilkins and Rosalind Franklin", "X-ray diffraction data of Meischer", "Electron microscopic studies by Chargaff"], correct: 1, explanation: "Watson and Crick (1953) used X-ray diffraction data from Wilkins and Franklin, combined with Chargaff's rules." },

    { id: 61, topic: "DNA Double Helix", q: "Chargaff's rule states that for double-stranded DNA:", options: ["A = G and T = C", "A + T = G + C always", "A + G = T + C and A/T = G/C = 1", "The ratio of purines to pyrimidines varies"], correct: 2, explanation: "A = T and G = C, so A/T = 1 and G/C = 1. Also total purines (A+G) = total pyrimidines (T+C)." },

    { id: 62, topic: "DNA Double Helix", q: "Consider:<br>(i) Two strands have parallel polarity<br>(ii) Backbone = sugar-phosphate<br>(iii) Bases project inside<br>(iv) A pairs with T through 3 H-bonds<br><br>How many are <b>correct</b>?", options: ["One", "Four", "Three", "Two"], correct: 3, explanation: "(i) Wrong — anti-parallel. (iv) Wrong — A=T has 2 H-bonds. Only (ii) and (iii) are correct = 2." },

    { id: 63, topic: "DNA Double Helix", q: "Number of hydrogen bonds between Guanine and Cytosine:", options: ["Three", "Two", "One", "Four"], correct: 0, explanation: "G≡C = 3 hydrogen bonds; A=T = 2 hydrogen bonds." },
    ...
    { id: 65, topic: "DNA Double Helix", q: "The pitch of a DNA double helix is:", options: ["0.34 nm", "3.4 nm", "2.0 nm", "34 nm"], correct: 1, explanation: "Pitch (one complete turn) = 3.4 nm, with ~10 bp per turn. Distance between bp = 0.34 nm." },

    { id: 66, topic: "DNA Double Helix", q: "If pitch is 3.4 nm and 10 bp per turn, distance between consecutive base pairs is:", options: ["0.034 nm", "3.4 nm", "0.34 nm", "34 nm"], correct: 2, explanation: "3.4 nm / 10 = 0.34 nm." },

    { id: 67, topic: "DNA Double Helix", q: "The two strands of DNA double helix are:", options: ["Parallel and identical", "Anti-parallel and identical", "Parallel and complementary", "Anti-parallel and complementary"], correct: 3, explanation: "DNA strands are anti-parallel (5'→3' and 3'→5') and complementary (A-T, G-C)." },

    { id: 68, topic: "DNA Double Helix", q: "Which contributes to helix stability IN ADDITION TO hydrogen bonding?", options: ["Stacking of base pairs over each other", "Ionic bonding between bases", "Covalent bonding between strands", "Van der Waals forces between sugar and phosphate"], correct: 0, explanation: "NCERT: 'The plane of one base pair stacks over the other, conferring stability in addition to H-bonds.'" },
    ...
    { id: 70, topic: "DNA Double Helix", q: "A DNA molecule has 1000 base pairs. Number of complete turns:", options: ["10", "1000", "100", "340"], correct: 2, explanation: "1000 / 10 = 100 turns." },

    { id: 71, topic: "DNA Double Helix", q: "Total length of DNA with 1000 bp:", options: ["34 nm", "0.34 nm", "3400 nm", "340 nm"], correct: 3, explanation: "1000 × 0.34 nm = 340 nm." },

    { id: 72, topic: "DNA Double Helix", q: "Central Dogma of molecular biology (Francis Crick):", options: ["DNA → RNA → Protein", "RNA → DNA → Protein", "DNA → Protein → RNA", "Protein → RNA → DNA"], correct: 0, explanation: "DNA → RNA (transcription) → Protein (translation)." },

    { id: 73, topic: "DNA Double Helix", q: "The process of RNA to DNA in some viruses is called:", options: ["Transcription", "Reverse transcription", "Translation", "Transduction"], correct: 1, explanation: "Reverse transcription = RNA → DNA, catalyzed by reverse transcriptase (e.g., in retroviruses)." },
    ...
    { id: 75, topic: "DNA Double Helix", q: "Statement 1: If one strand's sequence is known, the other can be predicted.<br>Statement 2: The two strands are complementary due to specific base pairing.", options: ["Both incorrect", "Both correct, S2 doesn't explain S1", "S1 correct, S2 incorrect", "Both correct, S2 explains S1"], correct: 3, explanation: "Complementary base pairing means knowing one strand allows prediction of the other." },

    { id: 76, topic: "DNA Double Helix", q: "If DNA has 500 Adenine bases, H-bonds between A and T:", options: ["1000", "500", "1500", "2000"], correct: 0, explanation: "A=T forms 2 H-bonds. 500 × 2 = 1000." },
    ...
    { id: 79, topic: "DNA Double Helix", q: "X-ray diffraction data crucial for DNA structure was produced by:", options: ["Watson and Crick", "Erwin Chargaff", "Maurice Wilkins and Rosalind Franklin", "Friedrich Meischer"], correct: 2, explanation: "Wilkins and Franklin produced the X-ray diffraction data." },

    { id: 80, topic: "DNA Double Helix", q: "Anti-parallel polarity means:", options: ["Both strands run 5'→3'", "Both strands run 3'→5'", "Polarity is absent", "One strand 5'→3' and other 3'→5'"], correct: 3, explanation: "Anti-parallel = one strand 5'→3', other 3'→5'." },

    { id: 81, topic: "DNA Double Helix", q: "If one strand is 5'-ATGCCA-3', the complementary strand:", options: ["3'-TACGGT-5'", "5'-ATGCCA-3'", "5'-TACCGT-3'", "5'-UACGGU-3'"], correct: 0, explanation: "Complementary: A-T, T-A, G-C, C-G, C-G, A-T → 3'-TACGGT-5'. D has uracil (RNA)." },
    ...
    { id: 83, topic: "DNA Double Helix", q: "Friedrich Meischer named the acidic substance as:", options: ["Chromatin", "Nucleosome", "Nuclein", "Nucleoid"], correct: 2, explanation: "Meischer (1869) named it 'Nuclein'." },

    { id: 84, topic: "DNA Double Helix", q: "A DNA has 1500 bp. Number of turns and total length:", options: ["15 turns; 51 nm", "150 turns; 5100 nm", "1500 turns; 510 nm", "150 turns; 510 nm"], correct: 3, explanation: "Turns = 1500/10 = 150. Length = 1500 × 0.34 = 510 nm." },

    { id: 85, topic: "DNA Double Helix", q: "Daughter DNA molecules after replication are:", options: ["Identical to parental DNA", "Different from parental DNA", "Contain only new strands", "Have no complementary pairing"], correct: 0, explanation: "Each parental strand acts as template, producing daughter DNA identical to parental DNA." },

    { id: 86, topic: "DNA Double Helix", q: "Which was NOT used by Watson and Crick?", options: ["X-ray data of Wilkins and Franklin", "Meischer's identification of nuclein", "Chargaff's rules", "Both A and B were used"], correct: 1, explanation: "Meischer's work (1869) was historical but not directly used in the 1953 model." },

    // Continuing from Q87...
    { id: 87, topic: "DNA Double Helix", q: "If Adenine = 30% of total bases, Cytosine percentage:", options: ["30%", "40%", "20%", "10%"], correct: 2, explanation: "A = T = 30%. A+T = 60%. G+C = 40%. G = C = 20%." },
    ...
    { id: 89, topic: "Packaging of DNA", q: "Approximate length of DNA in a typical mammalian cell:", options: ["2.2 cm", "2.2 μm", "2.2 mm", "2.2 m"], correct: 3, explanation: "6.6 × 10⁹ bp × 0.34 × 10⁻⁹ m/bp ≈ 2.2 metres." },

    { id: 90, topic: "Packaging of DNA", q: "Total base pairs used for calculating mammalian cell DNA length:", options: ["6.6 × 10⁹ bp", "3.3 × 10⁹ bp", "4.6 × 10⁶ bp", "2.2 × 10⁹ bp"], correct: 0, explanation: "Diploid cell: 2 × 3.3 × 10⁹ = 6.6 × 10⁹ bp." },

    { id: 91, topic: "Packaging of DNA", q: "In prokaryotes, DNA is organized in a region called:", options: ["Nucleus", "Nucleoid", "Nucleolus", "Nucleosome"], correct: 1, explanation: "Prokaryotes lack defined nucleus. DNA is in the nucleoid region." },

    { id: 92, topic: "Packaging of DNA", q: "DNA is negatively charged due to:", options: ["Histones", "Nitrogenous bases", "Phosphate groups in backbone", "Deoxyribose sugar"], correct: 2, explanation: "Phosphate groups carry negative charges, making DNA negatively charged." },

    { id: 93, topic: "Packaging of DNA", q: "Histones are rich in which amino acid residues?", options: ["Tryptophan and Phenylalanine", "Glycine and Alanine", "Glutamic acid and Aspartic acid", "Lysine and Arginine"], correct: 3, explanation: "Histones are rich in lysine and arginine — both carry positive charges." },

    { id: 94, topic: "Packaging of DNA", q: "A histone octamer is composed of:", options: ["Eight molecules of histones", "Eight different types of histone proteins", "Four molecules of histones", "Six molecules of histones"], correct: 0, explanation: "NCERT: 'Histones are organised to form a unit of eight molecules called histone octamer.'" },

    { id: 95, topic: "Packaging of DNA", q: "A typical nucleosome contains approximately:", options: ["100 bp", "200 bp", "146 bp", "500 bp"], correct: 1, explanation: "NCERT states: 'A typical nucleosome contains 200 bp of DNA helix.'" },

    { id: 96, topic: "Packaging of DNA", q: "The repeating unit of chromatin is:", options: ["Histone", "Nucleoid", "Nucleosome", "Chromosome"], correct: 2, explanation: "Nucleosomes constitute the repeating unit of chromatin." },

    { id: 97, topic: "Packaging of DNA", q: "'Beads-on-string' structure is visualized under:", options: ["Light microscope", "Scanning electron microscope", "Naked eye", "Electron microscope"], correct: 3, explanation: "Nucleosomes appear as beads-on-string when viewed under electron microscope (EM)." },
    ...
    { id: 99, topic: "Packaging of DNA", q: "Higher level chromatin packaging requires:", options: ["Non-histone chromosomal (NHC) proteins", "Only histone proteins", "RNA polymerase", "DNA ligase"], correct: 0, explanation: "NCERT: 'packaging at higher level requires Non-histone Chromosomal (NHC) proteins.'" },
    ...
    { id: 101, topic: "Packaging of DNA", q: "Consider:<br>(i) Euchromatin – loosely packed, stains light<br>(ii) Heterochromatin – densely packed, stains dark<br>(iii) Euchromatin – transcriptionally inactive<br>(iv) Heterochromatin – transcriptionally active<br><br>Which are correct?", options: ["(i), (ii) and (iii)", "(iii) and (iv) only", "(i) and (ii) only", "(i), (ii) and (iv)"], correct: 2, explanation: "(iii) and (iv) are REVERSED. Euchromatin = active; Heterochromatin = inactive." },

    { id: 102, topic: "Packaging of DNA", q: "If E. coli DNA length is 1.36 mm, the number of base pairs is approximately:", options: ["1.36 × 10⁶ bp", "4.6 × 10⁶ bp", "4.0 × 10⁵ bp", "4.0 × 10⁶ bp"], correct: 3, explanation: "1.36 × 10⁻³ m / (0.34 × 10⁻⁹ m) = 4.0 × 10⁶ bp." },
    ...
    { id: 104, topic: "Packaging of DNA", q: "Correct packaging sequence (lowest to highest):", options: ["Chromosome → Chromatin → Nucleosome → DNA", "Nucleosome → Chromatin fiber → Chromatin → Chromosome", "DNA helix → Histone octamer → Chromosome → Nucleosome", "Chromatin fiber → Nucleosome → DNA → Chromosome"], correct: 1, explanation: "DNA → Nucleosome → Chromatin fiber → further coiling → Chromosome (most condensed at metaphase)." },

    { id: 105, topic: "Packaging of DNA", q: "In prokaryotic nucleoid, DNA is organized as:", options: ["Nucleosomes wrapped around histones", "Linear chromosomes with telomeres", "Large loops held by proteins", "Chromatin fibers with NHC proteins"], correct: 2, explanation: "NCERT: 'DNA in nucleoid is organised in large loops held by proteins.'" },
    ...
    { id: 107, topic: "Packaging of DNA", q: "Statement 1: Chromatin = thread-like stained bodies in nucleus.<br>Statement 2: 'Chromatin' derives from 'chroma' meaning colour.", options: ["Both correct", "Only S2 correct", "Only S1 correct", "Both incorrect"], correct: 0, explanation: "Both statements are correct per NCERT." },
    ...
    { id: 111, topic: "Packaging of DNA", q: "Consider:<br>(i) DNA wraps around histone octamer → Nucleosome<br>(ii) Beads-on-string under EM<br>(iii) NHC proteins for higher packaging<br>(iv) Euchromatin = densely packed + inactive<br><br>How many correct?", options: ["All four", "One", "Two", "Three"], correct: 3, explanation: "(iv) is WRONG — Euchromatin is loosely packed and active. (i), (ii), (iii) are correct = 3." },

    { id: 112, topic: "Packaging of DNA", q: "Charge interaction in nucleosome formation:", options: ["Negative DNA + Positive histones", "Positive DNA + Negative histones", "Negative DNA + Negative histones", "Neutral DNA + Neutral histones"], correct: 0, explanation: "DNA (negative, phosphate groups) + histones (positive, lysine/arginine) = electrostatic attraction." },

    { id: 113, topic: "Packaging of DNA", q: "Select the <b>incorrect</b> match:", options: ["Euchromatin – Loosely packed – Active", "Nucleosome – 500 bp – Repeating unit", "Nucleoid – Prokaryotic DNA region", "Heterochromatin – Densely packed – Inactive"], correct: 1, explanation: "Nucleosome contains 200 bp, not 500 bp." },

    { id: 114, topic: "Packaging of DNA", q: "Correct relationship between packaging and gene expression:", options: ["Tightly packed = more active", "Loosely packed = inactive", "Loosely packed euchromatin = transcriptionally active", "Packaging has no effect"], correct: 2, explanation: "Euchromatin (loosely packed) allows access to transcription machinery = active." },

    { id: 115, topic: "Packaging of DNA", q: "A positively charged protein is likely rich in:", options: ["Glutamic acid", "Aspartic acid", "Leucine", "Arginine"], correct: 3, explanation: "Arginine (and lysine) carry positive charges. Glutamic/aspartic acid are negative." },

    { id: 116, topic: "Packaging of DNA", q: "The beads in beads-on-string model represent:", options: ["Nucleosomes", "Histones", "NHC proteins", "Base pairs"], correct: 0, explanation: "Beads = nucleosomes; string = linker DNA between nucleosomes." },
    ...
    { id: 119, topic: "Griffith's Experiment", q: "Griffith's transformation experiment was performed on:", options: ["E. coli", "Salmonella typhimurium", "Streptococcus pneumoniae", "Bacillus subtilis"], correct: 2, explanation: "Griffith (1928) worked with Streptococcus pneumoniae (pneumococcus)." },

    { id: 120, topic: "Griffith's Experiment", q: "S strain is virulent because:", options: ["It produces an endotoxin", "It produces antibiotic-resistant enzymes", "It lacks a cell wall", "It has a mucous (polysaccharide) coat"], correct: 3, explanation: "S strain has a mucous (polysaccharide) coat making them virulent." },
    ...
    { id: 122, topic: "Griffith's Experiment", q: "What was recovered from dead mice injected with heat-killed S + live R?", options: ["Only dead S strain", "Living S strain bacteria", "Only live R strain", "Heat-killed R strain"], correct: 1, explanation: "Living S bacteria were recovered — R strain transformed into virulent S strain." },

    { id: 123, topic: "Griffith's Experiment", q: "About Griffith's experiment:<br>(i) R strain transformed into S<br>(ii) Transforming principle enabled polysaccharide coat synthesis<br>(iii) Griffith concluded DNA was transforming principle<br>(iv) Transfer of genetic material occurred<br><br>Which are correct?", options: ["All four", "(i), (ii) and (iii)", "(i), (ii) and (iv) only", "(ii) and (iii) only"], correct: 2, explanation: "(iii) is WRONG — Griffith did NOT identify it as DNA. He called it 'transforming principle'." },
    ...
    { id: 125, topic: "Griffith's Experiment", q: "R strain colonies appear rough because:", options: ["Thick peptidoglycan layer", "Presence of flagella", "Endospore production", "Lack of polysaccharide coat"], correct: 3, explanation: "R strain lacks the polysaccharide coat, giving rough colony appearance." },

    { id: 126, topic: "Griffith's Experiment", q: "Correct chronological order:", options: ["Griffith → Avery et al. → Hershey-Chase", "Avery → Griffith → Hershey-Chase", "Griffith → Hershey-Chase → Avery et al.", "Hershey-Chase → Griffith → Avery"], correct: 0, explanation: "Griffith (1928) → Avery et al. (1933-44) → Hershey-Chase (1952)." },

    { id: 127, topic: "Griffith's Experiment", q: "Transformation of R to S strain is an example of:", options: ["Transduction", "Transformation", "Conjugation", "Translation"], correct: 1, explanation: "Transformation = cell takes up exogenous DNA from environment." },
    ...
    { id: 129, topic: "Griffith's Experiment", q: "Significance of Griffith's experiment:", options: ["Proved DNA is genetic material", "Showed proteins cause transformation", "Identified polysaccharide coat as genetic material", "Demonstrated transformation by substance from dead organism"], correct: 3, explanation: "Griffith demonstrated transformation but did NOT identify the chemical nature." },

    // ===== SET 7: AVERY, MacLEOD & McCARTY (Q130-Q136) =====
    { id: 130, topic: "Avery et al. Experiment", q: "Avery et al. aimed to determine:", options: ["Biochemical nature of transforming principle", "Structure of DNA", "Mechanism of DNA replication", "Process of protein synthesis"], correct: 0, explanation: "They worked to determine the biochemical nature of Griffith's transforming principle." },

    { id: 131, topic: "Avery et al. Experiment", q: "Transformation was inhibited when treated with:", options: ["Protease", "DNase", "RNase", "Lipase"], correct: 1, explanation: "DNase inhibited transformation, proving DNA was the transforming principle." },

    { id: 132, topic: "Avery et al. Experiment", q: "About Avery et al.:<br>(i) Proteases didn't affect transformation<br>(ii) RNases didn't affect transformation<br>(iii) DNase inhibited transformation<br>(iv) All biologists were convinced<br><br>Which are correct?", options: ["(i) and (iii) only", "All four", "(i), (ii) and (iii) only", "(ii) and (iv) only"], correct: 2, explanation: "(iv) is incorrect — 'not all biologists were convinced.'" },
    ...
    { id: 134, topic: "Avery et al. Experiment", q: "Prior to Avery et al., genetic material was thought to be:", options: ["DNA", "RNA", "Carbohydrate", "Protein"], correct: 3, explanation: "Before Avery et al., genetic material was thought to be a protein." },

    { id: 135, topic: "Avery et al. Experiment", q: "Correct difference between DNA and DNase:", options: ["DNA is polymer of nucleotides; DNase degrades DNA", "DNA is nucleic acid; DNase synthesizes DNA", "DNA is a protein; DNase is nucleic acid", "Both are enzymes"], correct: 0, explanation: "DNA = nucleic acid polymer. DNase = enzyme that degrades DNA." },
    ...
    { id: 138, topic: "Hershey-Chase Experiment", q: "Hershey and Chase used:", options: ["S. pneumoniae and mice", "Retroviruses and human cells", "TMV and tobacco", "Bacteriophages and E. coli"], correct: 3, explanation: "They worked with bacteriophages and E. coli." },

    { id: 139, topic: "Hershey-Chase Experiment", q: "Radioactive phosphorus (³²P) labelled:", options: ["DNA of virus", "Protein coat", "RNA of virus", "Polysaccharide coat"], correct: 0, explanation: "DNA contains phosphorus but protein doesn't. ³²P labels DNA." },

    { id: 140, topic: "Hershey-Chase Experiment", q: "Radioactive sulfur (³⁵S) labelled:", options: ["DNA", "Protein coat", "RNA", "Cell wall"], correct: 1, explanation: "Protein contains sulfur (cysteine, methionine) but DNA doesn't. ³⁵S labels protein." },

    { id: 141, topic: "Hershey-Chase Experiment", q: "Correct sequence of steps:<br>(i) Viruses grown on radioactive medium<br>(ii) Radioactive phages infect E. coli<br>(iii) Agitation in blender<br>(iv) Centrifugation", options: ["(i)→(ii)→(iv)→(iii)", "(ii)→(i)→(iii)→(iv)", "(i)→(ii)→(iii)→(iv)", "(iv)→(iii)→(ii)→(i)"], correct: 2, explanation: "Grow on radioactive medium → infect → blender → centrifuge." },

    { id: 142, topic: "Hershey-Chase Experiment", q: "Radioactivity found inside bacteria when phages labelled with:", options: ["³⁵S", "³H", "¹⁴C", "³²P"], correct: 3, explanation: "³²P-labelled DNA was found inside bacteria, confirming DNA enters the cell." },
    ...
    { id: 144, topic: "Hershey-Chase Experiment", q: "Basis for using ³²P for DNA and ³⁵S for protein:", options: ["DNA has phosphorus not sulfur; protein has sulfur not phosphorus", "DNA has sulfur; protein has phosphorus", "Both have phosphorus and sulfur", "Neither has phosphorus"], correct: 0, explanation: "DNA has P but no S. Protein has S but no P. This mutual exclusivity allows differential labelling." },

    { id: 145, topic: "Hershey-Chase Experiment", q: "The blender was used to:", options: ["Lyse bacterial cells", "Separate viral coats from bacteria by agitation", "Mix radioactive medium", "Denature DNA"], correct: 1, explanation: "The blender physically separated phage protein coats from bacteria." },

    { id: 146, topic: "Hershey-Chase Experiment", q: "The centrifuge was used to:", options: ["Replicate phage DNA", "Break cell walls", "Separate virus particles from bacteria", "Precipitate proteins"], correct: 2, explanation: "Centrifuge separates heavier bacteria (pellet) from lighter viral coats (supernatant)." },

    { id: 147, topic: "Hershey-Chase Experiment", q: "Statement 1: Hershey-Chase proved DNA passes from virus to bacteria.<br>Statement 2: Griffith identified biochemical nature as DNA.", options: ["Both correct", "Both incorrect", "Only S2 correct", "Only S1 correct"], correct: 3, explanation: "S2 is WRONG — Griffith did NOT identify it. Avery et al. did." },

    { id: 148, topic: "Hershey-Chase Experiment", q: "Conclusion of Hershey-Chase experiment:", options: ["DNA is genetic material passing from virus to bacteria", "Both DNA and protein enter host", "Protein is genetic material", "RNA is genetic material in phages"], correct: 0, explanation: "DNA is the genetic material that passes from virus to bacteria." },

    { id: 149, topic: "Hershey-Chase Experiment", q: "Consider:<br>(i) ³²P labels DNA<br>(ii) ³⁵S labels protein<br>(iii) DNA contains sulfur<br>(iv) Protein doesn't contain phosphorus<br><br>How many correct?", options: ["One", "Three", "Two", "Four"], correct: 1, explanation: "(iii) is WRONG — DNA does NOT contain sulfur. (i), (ii), (iv) are correct = 3." },

    // ===== SET 9: PROPERTIES OF GENETIC MATERIAL (Q150-Q178) =====
    { id: 150, topic: "Properties of Genetic Material", q: "Which is NOT a criterion for genetic material?", options: ["Replication", "Chemical/structural stability", "Catalyze metabolic reactions", "Scope for slow changes (mutations)"], correct: 2, explanation: "Four criteria: Replication, Stability, Mutation, Expression. Catalysis is NOT required." },

    { id: 151, topic: "Properties of Genetic Material", q: "Which criteria can BOTH DNA and RNA fulfill?", options: ["(i), (iii) and (iv) only", "(i) and (ii) only", "Only replication", "All four"], correct: 3, explanation: "Both can replicate, both have some stability, both can mutate, RNA can express directly. All four." },

    { id: 152, topic: "Properties of Genetic Material", q: "RNA is more labile because:", options: ["Has 2'-OH group making it reactive", "Contains uracil", "Single-stranded", "Has phosphodiester backbone"], correct: 0, explanation: "NCERT: '2'-OH group is a reactive group and makes RNA labile and easily degradable.'" },
    ...
    { id: 156, topic: "Properties of Genetic Material", q: "About DNA and RNA as genetic material:", options: ["Neither functions as genetic material", "RNA for storage; DNA for transmission", "Both equally preferred", "DNA for storage; RNA for transmission"], correct: 3, explanation: "NCERT: 'DNA is preferred for storage. For transmission, RNA is better.'" },

    { id: 157, topic: "Properties of Genetic Material", q: "RNA can directly code for proteins. This allows RNA to:", options: ["Easily express characters (Mendelian)", "Be better for storage", "Be more stable", "Prevent mutations"], correct: 0, explanation: "RNA can directly code for proteins, hence easily express characters." },

    { id: 158, topic: "Properties of Genetic Material", q: "Statement 1: DNA depends on RNA for protein synthesis.<br>Statement 2: Protein synthesis machinery evolved around RNA.", options: ["Only S1 correct", "Both correct", "Only S2 correct", "Both incorrect"], correct: 1, explanation: "Both are directly from NCERT." },
    ...
    { id: 160, topic: "Properties of Genetic Material", q: "Stability of genetic material after death was demonstrated by:", options: ["Hershey-Chase experiment", "Avery et al.'s DNase work", "Watson-Crick model", "Griffith's transforming principle"], correct: 3, explanation: "Heat killed bacteria but didn't destroy genetic material properties." },

    { id: 161, topic: "Properties of Genetic Material", q: "When denatured DNA strands reunite under appropriate conditions:", options: ["Renaturation (Annealing)", "Denaturation", "Degradation", "Transcription"], correct: 0, explanation: "Complementary strands come together = renaturation/annealing." },

    { id: 162, topic: "Properties of Genetic Material", q: "Proteins fail to qualify as genetic material because:", options: ["Cannot mutate", "Cannot replicate", "Not stable", "Too small"], correct: 1, explanation: "NCERT: 'proteins fail to fulfill first criteria itself' — replication." },
    ...
    { id: 164, topic: "Properties of Genetic Material", q: "All criteria for genetic material:", options: ["Transcription, Translation, Stability, Mutation", "Replication, Stability, Catalysis, Translation", "Replication, Stability, Mutation, Expression", "Replication, Mutation, Catalysis, Expression"], correct: 2, explanation: "NCERT four criteria: Replication, Stability, Mutation, Expression." },

    { id: 165, topic: "Properties of Genetic Material", q: "DNA vs RNA comparison:<br>(i) Stability: DNA > RNA ✓<br>(ii) Reactivity: DNA < RNA ✓<br>(iii) Mutation rate: DNA < RNA ✓<br>(iv) Direct protein coding: DNA yes, RNA no<br><br>How many rows correct?", options: ["One", "Two", "Four", "Three"], correct: 3, explanation: "(iv) is REVERSED — RNA can directly code; DNA depends on RNA. Three correct." },

    { id: 166, topic: "Properties of Genetic Material", q: "Two chemical differences between DNA and RNA:", options: ["DNA deoxyribose, RNA ribose; DNA thymine, RNA uracil", "DNA ribose, RNA deoxyribose; DNA uracil, RNA thymine", "DNA single strand, RNA double strand", "DNA phosphate, RNA no phosphate"], correct: 0, explanation: "Sugar: DNA=deoxyribose, RNA=ribose. Base: DNA=thymine, RNA=uracil." },

    { id: 167, topic: "Properties of Genetic Material", q: "Select the <b>incorrect</b> statement:", options: ["Both DNA and RNA can mutate", "DNA can directly code for proteins without RNA", "DNA is better for storage", "RNA mutates faster than DNA"], correct: 1, explanation: "DNA CANNOT directly code for proteins — depends on RNA." },

    { id: 168, topic: "Properties of Genetic Material", q: "Match:<br>(i) Griffith → (ii) Avery et al. → (iii) Hershey-Chase<br>with (P) Unequivocal proof (Q) Discovered transforming principle (R) Biochemical nature", options: ["(i)–R, (ii)–P, (iii)–Q", "(i)–P, (ii)–Q, (iii)–R", "(i)–Q, (ii)–R, (iii)–P", "(i)–Q, (ii)–P, (iii)–R"], correct: 2, explanation: "Griffith=Q, Avery=R, Hershey-Chase=P." },

    { id: 169, topic: "Properties of Genetic Material", q: "RNA as genetic material example from NCERT:", options: ["HIV and Influenza", "φ×174 and Adenovirus", "Lambda and T2 phage", "TMV and QB bacteriophage"], correct: 3, explanation: "NCERT specifically mentions TMV and QB bacteriophage." },

    { id: 170, topic: "Properties of Genetic Material", q: "Genetic material should not change with:", options: ["All of the above", "Age only", "Physiology changes only", "Different life cycle stages only"], correct: 0, explanation: "NCERT: 'not change with different stages of life cycle, age or with change in physiology.'" },
    ...
    { id: 173, topic: "Properties of Genetic Material", q: "Which molecules can self-replicate (required for genetic material)?", options: ["Proteins", "Carbohydrates", "Nucleic acids (DNA and RNA)", "Lipids"], correct: 2, explanation: "Only nucleic acids can direct their own duplication via base pairing." },

    { id: 174, topic: "Properties of Genetic Material", q: "What makes RNA suitable for transmission but not storage?", options: ["Highly stable", "Less reactive", "Cannot mutate", "Can directly code for proteins and act as messenger"], correct: 3, explanation: "RNA's ability to directly code proteins makes it ideal for transmission." },

    { id: 175, topic: "Properties of Genetic Material", q: "Heat-separated DNA strands can rejoin because:", options: ["Two strands are complementary", "Held by covalent bonds", "DNA contains uracil", "DNA is single-stranded"], correct: 0, explanation: "Complementary base pairing allows reannealing." },
    ...
    { id: 178, topic: "Properties of Genetic Material", q: "Consider:<br>(i) Griffith: Heat-killed S + live R → mice die ✓<br>(ii) Avery: DNA alone transforms ✓<br>(iii) Hershey: ³²P DNA found inside bacteria ✓<br>(iv) Hershey: ³⁵S protein found inside bacteria<br><br>Which correct?", options: ["(ii) and (iv) only", "All four", "(i) and (iv) only", "(i), (ii) and (iii) only"], correct: 3, explanation: "(iv) is WRONG — ³⁵S protein was found OUTSIDE (supernatant), not inside." },

    // ===== SET 10: RNA WORLD (Q179-Q186) =====
    { id: 179, topic: "RNA World", q: "According to RNA World hypothesis, first genetic material was:", options: ["RNA", "Protein", "DNA", "Carbohydrate"], correct: 0, explanation: "NCERT: 'RNA was the first genetic material.'" },
    ...
    { id: 182, topic: "RNA World", q: "About RNA World:<br>(i) RNA was first genetic material<br>(ii) Life processes evolved around RNA<br>(iii) RNA was catalyst and genetic material<br>(iv) DNA evolved before RNA<br><br>Which correct?", options: ["(i) and (iv)", "All four", "(i), (ii) and (iii) only", "(ii) and (iv)"], correct: 2, explanation: "(iv) is WRONG — RNA evolved first; DNA evolved FROM RNA." },

    { id: 183, topic: "RNA World", q: "Important biochemical reactions catalysed by RNA (not protein enzymes):", options: ["DNA replication only", "No reactions", "All metabolic reactions", "Some important reactions (e.g., peptide bond formation)"], correct: 3, explanation: "Some important biochemical reactions are catalysed by RNA catalysts (ribozymes)." },

    { id: 184, topic: "RNA World", q: "Correct evolutionary sequence of genetic material:", options: ["RNA → DNA", "Protein → DNA → RNA", "DNA → RNA → Protein", "DNA → RNA"], correct: 0, explanation: "RNA World: RNA was first, DNA evolved from RNA." },

    { id: 185, topic: "RNA World", q: "Statement 1: DNA has repair mechanism due to double-strandedness.<br>Statement 2: Complementary strand serves as template for error correction.", options: ["Both correct, S2 doesn't explain S1", "Both correct, S2 explains S1", "S1 correct, S2 incorrect", "Both incorrect"], correct: 1, explanation: "Complementary strand provides template for repair. S2 explains S1." },

    { id: 186, topic: "RNA World", q: "Catalytic nature of RNA made it:", options: ["More stable and less reactive", "Ideal for permanent storage", "Reactive and unsuitable for long-term genetic storage", "Unable to participate in life processes"], correct: 2, explanation: "Being catalytic = reactive = unsuitable for stable storage." },

    // ===== SET 11: SEMICONSERVATIVE REPLICATION (Q187-Q207) =====
    { id: 187, topic: "DNA Replication", q: "Semiconservative replication model was proposed by:", options: ["Meselson and Stahl", "Hershey and Chase", "Avery et al.", "Watson and Crick"], correct: 3, explanation: "Watson and Crick proposed semiconservative scheme (1953). Meselson-Stahl proved it (1958)." },

    { id: 188, topic: "DNA Replication", q: "In semiconservative replication, each daughter DNA has:", options: ["One parental + one new strand", "Two parental strands", "Two new strands", "One parental + two new strands"], correct: 0, explanation: "Each daughter DNA has one parental and one newly synthesised strand." },

    { id: 189, topic: "DNA Replication", q: "Experimental proof first demonstrated in:", options: ["Vicia faba", "Escherichia coli", "Human cells", "Drosophila"], correct: 1, explanation: "First shown in E. coli by Meselson and Stahl (1958)." },

    { id: 190, topic: "DNA Replication", q: "E. coli was first grown in medium containing:", options: ["¹⁴NH₄Cl", "³²P", "¹⁵NH₄Cl", "³⁵S"], correct: 2, explanation: "Grown in ¹⁵NH₄Cl (heavy nitrogen) for many generations." },

    { id: 191, topic: "DNA Replication", q: "Heavy and light DNA separated by:", options: ["Gel electrophoresis", "Autoradiography", "Paper chromatography", "CsCl density gradient centrifugation"], correct: 3, explanation: "Separated by CsCl density gradient centrifugation. ¹⁵N is NOT radioactive." },
    ...
    { id: 193, topic: "DNA Replication", q: "After one generation in ¹⁴N medium, DNA showed:", options: ["One hybrid (intermediate) band", "Only light band", "Only heavy band", "Two bands — heavy and light"], correct: 0, explanation: "Each DNA has one ¹⁵N + one ¹⁴N strand = hybrid density. One band." },

    { id: 194, topic: "DNA Replication", q: "After two generations in ¹⁴N medium:", options: ["Only heavy DNA", "Equal amounts of hybrid and light DNA", "Only hybrid DNA", "Only light DNA"], correct: 1, explanation: "Equal amounts of hybrid DNA and light DNA after two generations." },
    ...
    { id: 196, topic: "DNA Replication", q: "Semiconservative replication in eukaryotic chromosomes proved by:", options: ["Meselson-Stahl using E. coli", "Griffith using S. pneumoniae", "Hershey-Chase using phages", "Taylor using Vicia faba"], correct: 3, explanation: "Taylor and colleagues used Vicia faba (faba beans) with radioactive thymidine." },

    { id: 197, topic: "DNA Replication", q: "Taylor's experiment used which label?", options: ["Radioactive thymidine", "³²P", "¹⁵N", "³⁵S"], correct: 0, explanation: "Taylor used radioactive thymidine to label newly synthesized DNA." },

    { id: 198, topic: "DNA Replication", q: "Consider:<br>(i) Meselson-Stahl: ¹⁵N/¹⁴N in E. coli<br>(ii) Taylor: radioactive thymidine in V. faba<br>(iii) Both proved semiconservative replication<br>(iv) Both used CsCl gradient<br><br>Which correct?", options: ["All four", "(i), (ii) and (iii) only", "(i) and (iii) only", "(ii) and (iv) only"], correct: 1, explanation: "(iv) is WRONG — Taylor used autoradiography, not CsCl gradient." },

    { id: 199, topic: "DNA Replication", q: "The famous quote about 'copying mechanism' was by:", options: ["Meselson and Stahl", "Griffith", "Watson and Crick", "Avery et al."], correct: 2, explanation: "Watson and Crick's 1953 paper contained this famous quote." },

    { id: 200, topic: "DNA Replication", q: "Main enzyme of DNA replication:", options: ["RNA-dependent DNA polymerase", "DNA-dependent RNA polymerase", "RNA-dependent RNA polymerase", "DNA-dependent DNA polymerase"], correct: 3, explanation: "DNA-dependent DNA polymerase uses DNA template to polymerise deoxynucleotides." },

    { id: 201, topic: "DNA Replication", q: "Rate of polymerisation in E. coli:", options: ["2000 bp/sec", "200 bp/sec", "20,000 bp/sec", "200,000 bp/sec"], correct: 0, explanation: "E. coli (4.6×10⁶ bp) replicates in 18 min → ~2000 bp/sec." },
    ...
    { id: 203, topic: "DNA Replication", q: "Deoxyribonucleoside triphosphates serve dual purpose as:", options: ["Substrates and inhibitors", "Energy source and primers", "Substrates and energy source", "Catalysts and substrates"], correct: 2, explanation: "Act as substrates AND provide energy (terminal high-energy phosphates like ATP)." },
    ...
    { id: 205, topic: "DNA Replication", q: "DNA polymerase catalyses polymerisation in direction:", options: ["3'→5'", "Depends on template", "Both directions", "5'→3'"], correct: 3, explanation: "NCERT: 'polymerisation only in one direction, that is 5'→3'.'" },

    { id: 206, topic: "DNA Replication", q: "On template with 3'→5' polarity, replication is:", options: ["Continuous", "Discontinuous", "Bidirectional", "Not possible"], correct: 0, explanation: "Template 3'→5' = new strand 5'→3' = continuous (leading strand)." },
    ...
    { id: 209, topic: "DNA Replication", q: "Small opening in DNA helix where replication occurs:", options: ["Origin of replication", "Okazaki fragment", "Replication bubble", "Replication fork"], correct: 3, explanation: "Replication occurs within a small opening called replication fork." },

    { id: 210, topic: "DNA Replication", q: "Why can't two strands separate entirely during replication?", options: ["Very high energy requirement", "DNA polymerase works slowly", "DNA is circular", "Histones prevent separation"], correct: 0, explanation: "NCERT: 'cannot be separated in its entire length due to very high energy requirement.'" },

    { id: 211, topic: "DNA Replication", q: "About DNA polymerase:<br>(i) Can initiate replication alone<br>(ii) Works 5'→3' only<br>(iii) Uses DNA template<br>(iv) Uses dNTPs as substrates<br><br>How many correct?", options: ["One", "Three", "Two", "Four"], correct: 1, explanation: "(i) is WRONG — cannot initiate alone, needs primer. (ii), (iii), (iv) correct = 3." },

    { id: 212, topic: "DNA Replication", q: "Region where replication originates in E. coli:", options: ["Replication fork", "Okazaki fragment", "Origin of replication", "Primosome"], correct: 2, explanation: "Definite region called origin of replication. Replication doesn't start randomly." },

    { id: 213, topic: "DNA Replication", q: "Vectors in recombinant DNA need origin of replication because:", options: ["Provides antibiotic resistance", "Provides selectable marker", "Enables transcription", "Allows DNA to be propagated/replicated in host"], correct: 3, explanation: "NCERT: 'vectors provide the origin of replication' for propagation." },

    { id: 214, topic: "DNA Replication", q: "DNA replication in eukaryotes occurs during:", options: ["S phase", "G₁ phase", "G₂ phase", "M phase"], correct: 0, explanation: "Replication occurs at S-phase of cell cycle." },
    ...
    { id: 217, topic: "DNA Replication", q: "Mistakes during replication result in:", options: ["Polyploidy", "Crossing over", "Mutations", "Transformation"], correct: 2, explanation: "NCERT: 'Any mistake during replication would result into mutations.'" },

    { id: 218, topic: "DNA Replication", q: "Which is <b>incorrect</b> about replication?", options: ["Semiconservative", "DNA ligase joins Okazaki fragments", "Occurs at replication fork", "DNA polymerase can initiate on its own"], correct: 3, explanation: "DNA polymerases CANNOT initiate replication alone — need a primer." },
    ...
    { id: 221, topic: "DNA Replication", q: "Match:<br>(i) DNA polymerase → (ii) DNA ligase → (iii) Vector<br>with (P) Joins Okazaki (Q) Origin of replication (R) Main enzyme", options: ["(i)–Q, (ii)–R, (iii)–P", "(i)–P, (ii)–Q, (iii)–R", "(i)–R, (ii)–P, (iii)–Q", "(i)–R, (ii)–Q, (iii)–P"], correct: 2, explanation: "DNA polymerase=R, DNA ligase=P, Vector=Q." },

    { id: 222, topic: "DNA Replication", q: "Statement 1: Replication is energetically expensive.<br>Statement 2: Energy from dNTPs with high-energy terminal phosphates.", options: ["Only S1 correct", "Only S2 correct", "Both incorrect", "Both correct, S2 explains S1"], correct: 3, explanation: "dNTPs provide energy through high-energy phosphate bonds." },

    { id: 223, topic: "DNA Replication", q: "Which is NOT required for DNA replication?", options: ["Reverse transcriptase", "DNA-dependent DNA polymerase", "Deoxyribonucleoside triphosphates", "DNA template"], correct: 0, explanation: "Reverse transcriptase is for RNA→DNA, not normal replication." },

    { id: 224, topic: "DNA Replication", q: "Match experiments with organisms:<br>(i) Meselson-Stahl → Vicia faba<br>(ii) Taylor → E. coli<br>(iii) Hershey-Chase → Phage + E. coli<br><br>Which correct?", options: ["(i) and (ii)", "Only (iii)", "(ii) and (iii)", "All three"], correct: 1, explanation: "(i) and (ii) are SWAPPED! Meselson-Stahl=E. coli; Taylor=V. faba. Only (iii) correct." },

    { id: 225, topic: "DNA Replication", q: "Leading strand is synthesized:", options: ["Discontinuously as Okazaki fragments", "Continuously in 3'→5' direction", "Continuously in 5'→3' direction", "Without DNA polymerase"], correct: 2, explanation: "Leading strand = continuous in 5'→3' direction." },

    { id: 226, topic: "DNA Replication", q: "Why is discontinuous synthesis necessary on one strand?", options: ["DNA ligase works only on one strand", "Insufficient energy", "One strand has no template", "DNA polymerase can only synthesize 5'→3', creating problem on one template"], correct: 3, explanation: "Since polymerase only works 5'→3', one template requires discontinuous synthesis." },

    { id: 227, topic: "DNA Replication", q: "At generation zero (before transfer to ¹⁴N), DNA band:", options: ["Only heavy", "Only light", "Only hybrid", "Heavy and light"], correct: 0, explanation: "All DNA fully labelled with ¹⁵N = only heavy band." },

    { id: 228, topic: "DNA Replication", q: "Eukaryotic vs prokaryotic replication:", options: ["Eukaryotic DNA replicates during G₂", "Eukaryotic DNA replicates during S-phase", "Prokaryotic DNA has multiple origins", "Both replicate during M-phase"], correct: 1, explanation: "NCERT: eukaryotic replication at S-phase." },
    ...
    { id: 230, topic: "DNA Replication", q: "DNA polymerase ensures accurate replication through:", options: ["High speed", "Synthesizing in both directions", "Initiating without primer", "High fidelity (accuracy)"], correct: 3, explanation: "Polymerases catalyse with 'high degree of accuracy' — proofreading." },

    { id: 231, topic: "DNA Replication", q: "After 3 generations in ¹⁴N, hybrid and light DNA molecules:", options: ["2 hybrid, 6 light", "4 hybrid, 4 light", "6 hybrid, 2 light", "1 hybrid, 7 light"], correct: 0, explanation: "Total=8. Hybrid=2 (always). Light=8-2=6." },
    ...
    { id: 234, topic: "Transcription", q: "Transcription is the process of:", options: ["Copying DNA from DNA", "Synthesizing protein from mRNA", "Copying genetic information from DNA strand into RNA", "Replicating entire DNA"], correct: 2, explanation: "Transcription = copying genetic information from one DNA strand into RNA." },

    { id: 235, topic: "Transcription", q: "During transcription, adenine on template pairs with:", options: ["Thymine", "Adenine", "Guanine", "Uracil"], correct: 3, explanation: "In transcription, adenine pairs with uracil (not thymine, as in RNA)." },

    { id: 236, topic: "Transcription", q: "Key difference between replication and transcription:", options: ["In replication total DNA duplicated; in transcription only segment and one strand", "Replication copies segment; transcription duplicates entire DNA", "Both duplicate entire DNA", "Transcription doesn't follow complementarity"], correct: 0, explanation: "Replication = total DNA. Transcription = only a segment, only one strand." },

    { id: 237, topic: "Transcription", q: "Why both strands NOT copied:<br>(i) Would code different RNA sequences<br>(ii) Two complementary RNAs form dsRNA<br>(iii) dsRNA prevents translation<br>(iv) Both strands code same protein<br><br>Which correct?", options: ["All four", "(i), (ii) and (iii) only", "(i) and (iv)", "(ii) and (iii) only"], correct: 1, explanation: "(iv) is WRONG — they would code DIFFERENT proteins. (i), (ii), (iii) correct." },
    ...
    { id: 240, topic: "Transcription", q: "A transcription unit has three regions:", options: ["Origin, Structural gene, Terminus", "Operator, Structural gene, Regulator", "Enhancer, Intron, Exon", "Promoter, Structural gene, Terminator"], correct: 3, explanation: "Promoter, Structural gene, and Terminator." },

    { id: 241, topic: "Transcription", q: "Template strand has polarity:", options: ["3'→5'", "5'→3'", "No specific polarity", "Both directions"], correct: 0, explanation: "Template strand has 3'→5' polarity (RNA polymerase reads 3'→5', synthesizes 5'→3')." },
    ...
    { id: 244, topic: "Transcription", q: "The promoter is located:", options: ["Towards 3'-end (downstream)", "After terminator", "Within structural gene", "Towards 5'-end (upstream) of structural gene"], correct: 3, explanation: "Promoter is towards 5'-end (upstream) with respect to coding strand." },

    { id: 245, topic: "Transcription", q: "Promoter provides binding site for:", options: ["RNA polymerase", "Ribosomes", "DNA polymerase", "tRNA"], correct: 0, explanation: "Promoter provides binding site for RNA polymerase." },
    ...
    { id: 248, topic: "Transcription", q: "Given template 3'-ATGCATGCATGC-5', the RNA would be:", options: ["3'-UACGUACGUACG-5'", "5'-ATGCATGCATGC-3'", "5'-UACGUACGUACG-3'", "5'-TACGTACGTACG-3'"], correct: 2, explanation: "RNA synthesized 5'→3' reading template 3'→5'. A→U, T→A, G→C, C→G." },

    { id: 249, topic: "Transcription", q: "A cistron is:", options: ["Segment coding for tRNA", "Entire chromosome", "Segment coding for rRNA only", "Segment coding for a polypeptide"], correct: 3, explanation: "Cistron = segment of DNA coding for a polypeptide." },

    { id: 250, topic: "Transcription", q: "Structural genes in eukaryotes are mostly:", options: ["Monocistronic", "Polycistronic", "Without promoters", "Lacking introns"], correct: 0, explanation: "Monocistronic in eukaryotes; polycistronic in prokaryotes." },

    { id: 251, topic: "Transcription", q: "Consider:<br>(i) Exons appear in mature RNA<br>(ii) Introns don't appear in mature RNA<br>(iii) Split genes mainly in prokaryotes<br>(iv) Eukaryotic genes have interrupted coding<br><br>Which correct?", options: ["(i), (ii) and (iii)", "(i), (ii) and (iv) only", "All four", "(i) and (ii) only"], correct: 1, explanation: "(iii) is WRONG — split genes are in eukaryotes, not prokaryotes." },

    { id: 252, topic: "Transcription", q: "Exons are:", options: ["Sequences removed during splicing", "Intervening sequences", "Sequences appearing in mature/processed RNA", "Regulatory sequences upstream of promoter"], correct: 2, explanation: "Exons appear in mature or processed RNA." },
    ...
    { id: 254, topic: "Transcription", q: "Correct roles of three RNA types:", options: ["mRNA-template; tRNA-structural; rRNA-adapter", "mRNA-adapter; tRNA-structural; rRNA-template", "mRNA-catalytic; tRNA-template; rRNA-adapter", "mRNA-template; tRNA-adapter/reads code; rRNA-structural+catalytic"], correct: 3, explanation: "mRNA=template, tRNA=adapter (reads code, brings amino acids), rRNA=structural+catalytic." },

    { id: 255, topic: "Transcription", q: "In bacteria, all RNA types are transcribed by:", options: ["A single DNA-dependent RNA polymerase", "DNA-dependent DNA polymerase", "Three different RNA polymerases", "RNA-dependent RNA polymerase"], correct: 0, explanation: "Single DNA-dependent RNA polymerase in bacteria (vs 3 in eukaryotes)." },

    { id: 256, topic: "Transcription", q: "Three steps of transcription in correct order:", options: ["Elongation → Initiation → Termination", "Initiation → Elongation → Termination", "Initiation → Termination → Elongation", "Termination → Elongation → Initiation"], correct: 1, explanation: "Initiation → Elongation → Termination." },

    { id: 257, topic: "Transcription", q: "RNA polymerase alone is capable of catalysing only:", options: ["Initiation", "Termination", "Elongation", "All three steps"], correct: 2, explanation: "RNA polymerase alone can only do elongation. Needs σ for initiation, ρ for termination." },

    { id: 258, topic: "Transcription", q: "Sigma (σ) factor is associated with:", options: ["Termination", "Splicing", "Elongation", "Initiation"], correct: 3, explanation: "σ factor = initiation factor for transcription." },

    { id: 259, topic: "Transcription", q: "Rho (ρ) factor is involved in:", options: ["Termination", "Elongation", "Initiation", "Splicing"], correct: 0, explanation: "ρ factor = termination factor for transcription." },

    { id: 260, topic: "Transcription", q: "About transcription:<br>(i) RNA polymerase binds promoter<br>(ii) Uses nucleoside triphosphates as substrate<br>(iii) Facilitates helix opening<br>(iv) Can initiate without additional factors<br><br>Which correct?", options: ["All four", "(i), (ii) and (iii) only", "(i) and (ii) only", "(ii) and (iv) only"], correct: 1, explanation: "(iv) is WRONG — needs σ factor for initiation. (i), (ii), (iii) correct." },

    { id: 261, topic: "Transcription", q: "Coupled transcription-translation in bacteria because:", options: ["mRNA requires extensive processing", "Bacteria have 3 RNA polymerases", "No separation of cytosol and nucleus; mRNA needs no processing", "Bacteria have membrane-bound ribosomes"], correct: 2, explanation: "No nuclear membrane + no mRNA processing = coupled transcription-translation." },

    { id: 262, topic: "Transcription", q: "Match RNA polymerase with product in eukaryotes:<br>(i) Pol I → (ii) Pol II → (iii) Pol III<br>with (P) hnRNA (Q) tRNA/5S rRNA/snRNAs (R) rRNAs (28S,18S,5.8S)", options: ["(i)–R, (ii)–Q, (iii)–P", "(i)–P, (ii)–Q, (iii)–R", "(i)–Q, (ii)–R, (iii)–P", "(i)–R, (ii)–P, (iii)–Q"], correct: 3, explanation: "Pol I=rRNAs(R), Pol II=hnRNA(P), Pol III=tRNA/5S/snRNAs(Q)." },

    { id: 263, topic: "Transcription", q: "RNA Polymerase II transcribes:", options: ["Precursor of mRNA (hnRNA)", "tRNA and 5S rRNA", "rRNA (28S, 18S, 5.8S)", "snRNAs only"], correct: 0, explanation: "RNA Pol II transcribes hnRNA (heterogeneous nuclear RNA), precursor of mRNA." },
    ...
    { id: 265, topic: "Transcription", q: "Three processing steps for hnRNA → mature mRNA:", options: ["Capping, Tailing, Replication", "Splicing, Replication, Translation", "Splicing, Capping, Tailing", "Initiation, Elongation, Termination"], correct: 2, explanation: "Splicing (remove introns) + Capping (5' end) + Tailing (3' end)." },

    { id: 266, topic: "Transcription", q: "In capping, which molecule is added to 5'-end of hnRNA?", options: ["Poly-A tail", "Uridine monophosphate", "Adenylate residues", "Methyl guanosine triphosphate"], correct: 3, explanation: "Unusual nucleotide methyl guanosine triphosphate added to 5'-end." },

    { id: 267, topic: "Transcription", q: "In tailing, what is added to 3'-end?", options: ["200-300 adenylate residues", "100-200 uridylate residues", "Methyl guanosine triphosphate", "50-100 cytidylate residues"], correct: 0, explanation: "200-300 adenylate residues (poly-A tail) added at 3'-end, template-independent." },
    ...
    { id: 270, topic: "Transcription", q: "Which RNA polymerase transcribes tRNA in eukaryotes?", options: ["RNA Pol I", "RNA Pol III", "RNA Pol II", "RNA Pol IV"], correct: 1, explanation: "RNA Pol III transcribes tRNA, 5S rRNA, and snRNAs." },
    ...
    { id: 272, topic: "Transcription", q: "Split-gene arrangement and splicing relate to:", options: ["Dominance of DNA world", "Central dogma only", "Protein world hypothesis", "Dominance of RNA world"], correct: 3, explanation: "NCERT: 'splicing represents the dominance of RNA-world.'" },

    { id: 273, topic: "Transcription", q: "Which rRNA is transcribed by RNA Pol III?", options: ["5S rRNA", "18S rRNA", "5.8S rRNA", "28S rRNA"], correct: 0, explanation: "Pol I = 28S, 18S, 5.8S. Pol III = 5S rRNA (+ tRNA, snRNAs)." },

    // ===== SET 14: GENETIC CODE (Q274-Q284) =====
    { id: 274, topic: "Genetic Code", q: "Triplet nature of genetic code was proposed by:", options: ["Har Gobind Khorana", "George Gamow", "Marshall Nirenberg", "Severo Ochoa"], correct: 1, explanation: "George Gamow (physicist) proposed triplet code." },

    { id: 275, topic: "Genetic Code", q: "Number of possible codons from 4 bases taken 3 at a time:", options: ["12", "16", "64", "20"], correct: 2, explanation: "4³ = 4 × 4 × 4 = 64 codons." },

    { id: 276, topic: "Genetic Code", q: "Cell-free system for protein synthesis was developed by:", options: ["George Gamow", "Har Gobind Khorana", "Severo Ochoa", "Marshall Nirenberg"], correct: 3, explanation: "Marshall Nirenberg's cell-free system helped decipher the code." },

    { id: 277, topic: "Genetic Code", q: "Polynucleotide phosphorylase (Ochoa's enzyme) was useful for:", options: ["Enzymatic synthesis of RNA with defined sequences (template-independent)", "DNA replication", "Protein synthesis", "DNA repair"], correct: 0, explanation: "Ochoa's enzyme polymerised RNA with defined sequences template-independently." },

    { id: 278, topic: "Genetic Code", q: "Features of genetic code:<br>(i) Triplet codon<br>(ii) Degenerate<br>(iii) Has punctuations between codons<br>(iv) Nearly universal<br><br>Which correct?", options: ["All four", "(i), (ii) and (iv) only", "(i) and (iii)", "(ii) and (iv) only"], correct: 1, explanation: "(iii) is WRONG — NO punctuations. Code is read contiguously." },

    { id: 279, topic: "Genetic Code", q: "Genetic code is degenerate because:", options: ["One codon codes for more than one amino acid", "All 64 codons code for amino acids", "Some amino acids coded by more than one codon", "Code has punctuations"], correct: 2, explanation: "Degenerate = multiple codons for same amino acid (e.g., UUU and UUC both = Phe)." },

    { id: 280, topic: "Genetic Code", q: "AUG codon has dual function — codes for:", options: ["Methionine + stop codon", "Valine + stop codon", "Tryptophan + initiator codon", "Methionine + initiator codon"], correct: 3, explanation: "AUG = Methionine AND initiator codon." },

    { id: 281, topic: "Genetic Code", q: "Stop codons are:", options: ["UAA, UAG, UGA", "AUG, UAA, UAG", "AUG, UGA, UAG", "UAA, UGA, AUG"], correct: 0, explanation: "UAA, UAG, UGA are stop/termination codons. AUG = start codon." },

    { id: 282, topic: "Genetic Code", q: "Exceptions to universal genetic code found in:", options: ["All bacteria and fungi", "Mitochondrial codons and some protozoans", "All plants and animals", "Only viruses"], correct: 1, explanation: "Exceptions in mitochondrial codons and some protozoans." },
    ...
    { id: 285, topic: "Mutations", q: "Sickle cell anemia involves:", options: ["Deletion of entire beta-globin gene", "Duplication of beta-globin gene", "Insertion of 3 bp in alpha-globin", "Single base pair change: glutamate → valine"], correct: 3, explanation: "Point mutation: single base pair change, glutamate replaced by valine." },

    { id: 286, topic: "Mutations", q: "Frameshift mutations are caused by:", options: ["Insertion or deletion of one or two bases", "Substitution of one base", "Insertion or deletion of three bases", "Inversion of gene segment"], correct: 0, explanation: "Insertion/deletion of 1 or 2 bases changes reading frame = frameshift." },

    { id: 287, topic: "Mutations", q: "Insertion/deletion of 3 bases doesn't cause frameshift because:", options: ["3 bases cancel out", "3 bases = one codon, only one amino acid added/removed, frame unaltered", "DNA repair corrects it", "3 bases don't form codon"], correct: 1, explanation: "3 bases = 1 codon. One amino acid inserted/deleted, reading frame remains intact." },

    { id: 288, topic: "Mutations", q: "AUG UUU UUC UUU — if 'A' inserted after AUG, reading frame becomes:", options: ["AUG UUU AUU CUU U...", "AUG UUU UUC UUU", "AUG AUU UUU CUU U...", "No change"], correct: 2, explanation: "Insertion shifts all subsequent bases: AUG-AUU-UUU-CUU-U... = frameshift." },

    { id: 289, topic: "Mutations", q: "Statement 1: Point mutations involve single base pair change.<br>Statement 2: ALL point mutations cause frameshift.", options: ["Both correct", "Both incorrect", "Only S2 correct", "Only S1 correct"], correct: 3, explanation: "S2 is WRONG — substitutions don't cause frameshift. Only insertions/deletions do." },

    // ===== SET 16: tRNA ADAPTER MOLECULE (Q290-Q298) =====
    { id: 290, topic: "tRNA", q: "Adapter molecule concept was postulated by:", options: ["Francis Crick", "George Gamow", "Marshall Nirenberg", "Khorana"], correct: 0, explanation: "Francis Crick postulated the adapter molecule concept." },
    ...
    { id: 292, topic: "tRNA", q: "Secondary structure of tRNA looks like:", options: ["Inverted L", "Double helix", "Clover-leaf", "Linear chain"], correct: 2, explanation: "Secondary structure = clover-leaf. Actual 3D structure = inverted L." },

    { id: 293, topic: "tRNA", q: "Actual 3D structure of tRNA resembles:", options: ["Clover-leaf", "Double helix", "Circular molecule", "Inverted L"], correct: 3, explanation: "Actual structure = inverted L (compact). Clover-leaf is secondary structure." },

    { id: 294, topic: "tRNA", q: "Which is <b>incorrect</b> about tRNA?", options: ["Specific tRNAs for stop codons exist", "Initiator tRNA exists", "Specific for each amino acid", "Anticodon loop has bases complementary to codon"], correct: 0, explanation: "NO tRNAs for stop codons. Stop codons recognized by release factors." },
    ...
    { id: 298, topic: "tRNA", q: "Match:<br>(i) Gamow (ii) Khorana (iii) Nirenberg (iv) Ochoa<br>with (P) Chemical RNA synthesis (Q) Triplet code (R) Polynucleotide phosphorylase (S) Cell-free system", options: ["(i)–S, (ii)–P, (iii)–Q, (iv)–R", "(i)–P, (ii)–Q, (iii)–R, (iv)–S", "(i)–Q, (ii)–R, (iii)–P, (iv)–S", "(i)–Q, (ii)–P, (iii)–S, (iv)–R"], correct: 3, explanation: "Gamow=Q, Khorana=P, Nirenberg=S, Ochoa=R." },

    // ===== SET 17: TRANSLATION (Q299-Q323) =====
    { id: 299, topic: "Translation", q: "Translation refers to:", options: ["Polymerisation of amino acids to form polypeptide", "Copying DNA to RNA", "Replication of DNA", "Splicing of hnRNA"], correct: 0, explanation: "Translation = polymerisation of amino acids to form polypeptide." },

    { id: 300, topic: "Translation", q: "Amino acid sequence defined by:", options: ["Sequence of amino acids in tRNA", "Sequence of bases in mRNA", "Sequence of bases in rRNA", "Structure of ribosomes"], correct: 1, explanation: "Order of amino acids defined by sequence of bases in mRNA." },

    { id: 301, topic: "Translation", q: "Bond joining amino acids in polypeptide:", options: ["Hydrogen bond", "Phosphodiester bond", "Peptide bond", "Glycosidic bond"], correct: 2, explanation: "Amino acids joined by peptide bonds." },

    { id: 302, topic: "Translation", q: "Charging of tRNA involves:", options: ["tRNA linking to ribosome with GTP", "Peptide bond formation", "Removal of amino acids from tRNA", "Amino acid activation and linkage to cognate tRNA with ATP"], correct: 3, explanation: "Amino acids activated with ATP and linked to cognate tRNA = aminoacylation." },
    ...
    { id: 304, topic: "Translation", q: "Ribosome consists of:", options: ["Structural RNAs and about 80 different proteins", "Only structural RNAs", "Only proteins (~80 types)", "DNA and proteins"], correct: 0, explanation: "Ribosome = structural RNAs + about 80 different proteins." },
    ...
    { id: 306, topic: "Translation", q: "Translation begins when:", options: ["Large subunit encounters mRNA", "Both subunits simultaneously bind", "Small subunit encounters mRNA", "tRNA binds ribosome first"], correct: 2, explanation: "NCERT: 'When the small subunit encounters an mRNA, translation begins.'" },

    { id: 307, topic: "Translation", q: "Two sites for amino acid binding are in:", options: ["Small subunit", "tRNA", "mRNA", "Large subunit"], correct: 3, explanation: "Two sites in large subunit for amino acids to bind (A-site and P-site)." },

    { id: 308, topic: "Translation", q: "Peptide bond formation catalysed by:", options: ["23S rRNA (ribozyme) in bacteria", "RNA polymerase", "DNA polymerase", "Protein enzymes only"], correct: 0, explanation: "23S rRNA = ribozyme = catalyses peptide bond formation." },
    ...
    { id: 311, topic: "Translation", q: "Translational unit in mRNA is:", options: ["Entire mRNA including UTRs", "Only 5'-UTR", "Sequence flanked by start (AUG) and stop codon", "Only poly-A tail"], correct: 2, explanation: "Translational unit = start codon to stop codon." },

    { id: 312, topic: "Translation", q: "UTRs are present:", options: ["Only at 5'-end", "Only at 3'-end", "Within coding sequence", "At both 5'-end (before start) and 3'-end (after stop)"], correct: 3, explanation: "UTRs at both ends — 5'-UTR (before AUG) and 3'-UTR (after stop codon)." },

    { id: 313, topic: "Translation", q: "Role of UTRs:", options: ["Required for efficient translation", "Act as introns", "Code for additional amino acids", "Serve as origin of replication"], correct: 0, explanation: "UTRs are required for efficient translation but are not translated." },
    ...
    { id: 315, topic: "Translation", q: "During elongation:", options: ["Amino acids removed one by one", "Ribosome remains stationary", "Amino acid-tRNA complexes bind to codons via anticodon base pairing", "Release factors bind"], correct: 2, explanation: "Amino acid-tRNA complexes bind to appropriate codons through complementary anticodons." },

    { id: 316, topic: "Translation", q: "Translation terminated when:", options: ["Ribosome reaches 5'-end", "ATP depleted", "Initiator tRNA detaches", "Release factor binds to stop codon"], correct: 3, explanation: "Release factor binds to stop codon, terminating translation." },
    ...
    { id: 319, topic: "Translation", q: "Which is <b>incorrect</b> about translation?", options: ["Ribosome moves codon to codon along mRNA", "Small subunit has 2 amino acid binding sites", "Amino acids added per mRNA sequence", "Polypeptide released at stop codon"], correct: 1, explanation: "2 binding sites are in LARGE subunit, not small." },

    { id: 320, topic: "Translation", q: "Statement 1: Ribosome is both structural framework and catalyst.<br>Statement 2: 23S rRNA catalyses peptide bond (ribozyme).", options: ["Only S1 correct", "Both correct, S2 doesn't explain S1", "Both correct, S2 explains S1", "Only S2 correct"], correct: 2, explanation: "23S rRNA provides the molecular basis for catalytic function described in S1." },

    { id: 321, topic: "Translation", q: "Match:<br>(i) Charging tRNA (ii) Initiation (iii) Elongation (iv) Termination<br>with (P) Release factor (Q) AA + tRNA + ATP (R) Small subunit at AUG (S) AAs added one by one", options: ["(i)–Q, (ii)–S, (iii)–R, (iv)–P", "(i)–R, (ii)–Q, (iii)–P, (iv)–S", "(i)–S, (ii)–P, (iii)–Q, (iv)–R", "(i)–Q, (ii)–R, (iii)–S, (iv)–P"], correct: 3, explanation: "Charging=Q, Initiation=R, Elongation=S, Termination=P." },

    { id: 322, topic: "Translation", q: "Polypeptide sequences dictated by:", options: ["DNA represented through mRNA", "rRNA", "DNA directly", "tRNA sequences"], correct: 0, explanation: "Dictated by DNA and represented by mRNA." },

    { id: 323, topic: "Translation", q: "Aminoacylation of tRNA is also known as:", options: ["Translation", "Charging of tRNA", "Transcription", "Splicing"], correct: 1, explanation: "Charging of tRNA = aminoacylation of tRNA." },
    ...
    { id: 326, topic: "Gene Regulation", q: "Beta-galactosidase catalyses:", options: ["Hydrolysis of lactose into galactose and glucose", "Synthesis of lactose", "Glucose to galactose conversion", "Polymerisation of galactose"], correct: 0, explanation: "Hydrolysis of disaccharide lactose → galactose + glucose." },

    { id: 327, topic: "Gene Regulation", q: "About gene regulation:<br>(i) Metabolic/physiological/environmental conditions regulate expression<br>(ii) Development involves coordinated regulation<br>(iii) Gene expression is always constitutive<br>(iv) Prokaryotic regulation mainly at transcriptional initiation<br><br>Which correct?", options: ["All four", "(i), (ii) and (iv) only", "(i) and (iii)", "(ii) and (iv) only"], correct: 1, explanation: "(iii) is WRONG — expression is tightly regulated, not always constitutive." },
    ...
    { id: 330, topic: "Gene Regulation", q: "Operator region in prokaryotic operon is:", options: ["Far from promoter", "At 3'-end of mRNA", "Part of structural gene", "Adjacent to promoter in most operons"], correct: 3, explanation: "Operator is adjacent to promoter elements in most operons." },

    { id: 331, topic: "Gene Regulation", q: "Operator-repressor interaction:", options: ["Each operon has specific operator and specific repressor", "All operons share common operator and repressor", "Operators bind only activators", "Repressors bind to terminator"], correct: 0, explanation: "Each operon has its SPECIFIC operator and SPECIFIC repressor." },

    { id: 332, topic: "Gene Regulation", q: "About lac operon:<br>(i) Lac operator only in lac operon<br>(ii) Lac repressor only interacts with lac operator<br>(iii) Lac operator binds repressors from other operons<br>(iv) Beta-galactosidase hydrolyses lactose<br><br>Which correct?", options: ["(i), (ii) and (iii)", "(i), (ii) and (iv) only", "All four", "(i) and (iv) only"], correct: 1, explanation: "(iii) is WRONG — lac operator only interacts with lac repressor specifically." },

    { id: 333, topic: "Gene Regulation", q: "RNA polymerase activity at promoter regulated by:", options: ["DNA polymerase", "tRNA molecules", "Accessory proteins (activators and repressors)", "Ribosomes"], correct: 2, explanation: "Interaction with accessory proteins affects ability to recognise start sites." },

    { id: 334, topic: "Gene Regulation", q: "Select <b>incorrect</b> statement:", options: ["Eukaryotes: 4 levels of regulation", "Prokaryotes: transcriptional initiation is main point", "Environmental conditions regulate expression", "Repressor proteins always activate expression"], correct: 3, explanation: "Repressors INHIBIT expression (negative regulation), they don't activate." },

    { id: 335, topic: "Gene Regulation", q: "Correct sequence of regulatory elements in prokaryotic operon:", options: ["Promoter → Operator → Structural gene → Terminator", "Terminator → Gene → Operator → Promoter", "Operator → Promoter → Terminator → Gene", "Gene → Promoter → Operator → Terminator"], correct: 0, explanation: "Promoter → Operator → Structural gene(s) → Terminator." },
    ...
    { id: 337, topic: "Gene Regulation", q: "Statement 1: Processing-level regulation possible in eukaryotes only.<br>Statement 2: Prokaryotic mRNA needs no processing; eukaryotic hnRNA does.", options: ["Both correct, S2 doesn't explain S1", "Both correct, S2 explains S1", "S1 correct, S2 incorrect", "Both incorrect"], correct: 1, explanation: "Prokaryotic mRNA is directly functional. Eukaryotic needs processing. S2 explains S1." },

    { id: 338, topic: "Gene Regulation", q: "Development/differentiation of embryo results from:", options: ["Random gene expression", "Expression of only one gene", "Coordinated regulation of several gene sets", "Suppression of all expression"], correct: 2, explanation: "Coordinated regulation of expression of several sets of genes." },

    { id: 339, topic: "Gene Regulation", q: "Which regulation levels NOT applicable to prokaryotes?", options: ["(i) Transcriptional only", "(ii), (iii) and (iv) Translational", "(i), (ii) and (iii)", "(ii) Processing and (iii) Transport of mRNA"], correct: 3, explanation: "Prokaryotes lack nuclear compartment (no transport regulation) and mRNA needs no processing." },

    { id: 340, topic: "Gene Regulation", q: "Negative regulation of gene expression:", options: ["Repressor binds operator, blocks transcription", "Activator binds promoter, enhances transcription", "Sigma factor initiates transcription", "Release factor terminates translation"], correct: 0, explanation: "Negative = repressor binds operator → blocks transcription." },
    ...
    { id: 343, topic: "Gene Regulation", q: "Gene expression related to cellular function:", options: ["All genes expressed all times in all cells", "Only structural genes active", "Completely random", "Genes expressed for specific functions, regulated by need"], correct: 3, explanation: "Genes expressed for particular functions, regulated by conditions." },

    // ===== SET 19: LAC OPERON (Q344-Q388) =====
    { id: 344, topic: "Lac Operon", q: "Lac operon was elucidated by:", options: ["Francois Jacob and Jacque Monod", "Meselson and Stahl", "Watson and Crick", "Hershey and Chase"], correct: 0, explanation: "Jacob (geneticist) and Monod (biochemist) elucidated the lac operon." },
    ...
    { id: 346, topic: "Lac Operon", q: "The 'i' gene derives its name from:", options: ["Inducer", "Initiator", "Inhibitor", "Integrator"], correct: 2, explanation: "i = INHIBITOR (not inducer). It codes for repressor protein. Classic NEET trap." },

    { id: 347, topic: "Lac Operon", q: "The i gene codes for:", options: ["Beta-galactosidase", "Permease", "Transacetylase", "Repressor protein"], correct: 3, explanation: "i gene codes for the repressor of lac operon." },
    ...
    { id: 350, topic: "Lac Operon", q: "y gene product (permease) function:", options: ["Hydrolyse lactose", "Repress operon", "Increase cell permeability to β-galactosides", "Acetylate galactosides"], correct: 2, explanation: "Permease increases permeability of cell to β-galactosides." },

    { id: 351, topic: "Lac Operon", q: "All three gene products are required for:", options: ["DNA replication", "Transcription of other operons", "Amino acid synthesis", "Metabolism of lactose"], correct: 3, explanation: "All three needed for lactose metabolism." },

    { id: 352, topic: "Lac Operon", q: "Lactose acts as inducer because:", options: ["Is substrate for β-galactosidase and regulates switching on/off", "Directly activates RNA polymerase", "Destroys structural genes", "Enhances repressor synthesis"], correct: 0, explanation: "Lactose = substrate AND inducer — regulates the operon." },

    { id: 353, topic: "Lac Operon", q: "About lac operon:<br>(i) Repressor synthesised constitutively from i gene<br>(ii) Without lactose, repressor binds operator, blocks transcription<br>(iii) With lactose, repressor inactivated by inducer<br>(iv) Repressor synthesised only when lactose present<br><br>Which correct?", options: ["All four", "(i), (ii) and (iii) only", "(i) and (iv)", "(ii) and (iii) only"], correct: 1, explanation: "(iv) is WRONG — repressor made ALL THE TIME (constitutively). (i), (ii), (iii) correct." },
    ...
    { id: 355, topic: "Lac Operon", q: "Without lactose, lac operon is:", options: ["ON — all genes transcribed", "Partially active — only z transcribed", "OFF — repressor binds operator, blocks RNA polymerase", "Completely degraded"], correct: 2, explanation: "Repressor binds operator → prevents RNA polymerase → operon OFF." },

    { id: 356, topic: "Lac Operon", q: "With lactose/allolactose, operon ON because:", options: ["Lactose directly activates RNA polymerase", "i gene stops producing repressor", "Lactose degrades operator", "Inducer inactivates repressor → RNA polymerase accesses promoter"], correct: 3, explanation: "Inducer inactivates repressor → RNA polymerase accesses promoter → transcription." },

    { id: 357, topic: "Lac Operon", q: "Which can act as inducer for lac operon?", options: ["Lactose or allolactose", "Galactose", "Glucose", "Sucrose"], correct: 0, explanation: "NCERT: only lactose or allolactose. Glucose/galactose CANNOT." },

    { id: 358, topic: "Lac Operon", q: "Which CANNOT act as inducer?", options: ["Lactose", "Glucose", "Allolactose", "Both A and B can"], correct: 1, explanation: "Glucose and galactose cannot act as inducers for lac operon." },
    ...
    { id: 360, topic: "Lac Operon", q: "Lac operon regulation can be viewed as:", options: ["Regulation by product", "Regulation by temperature", "Regulation of enzyme synthesis by its substrate", "Regulation by DNA methylation"], correct: 2, explanation: "Lactose (substrate) regulates β-galactosidase (enzyme) synthesis." },

    { id: 361, topic: "Lac Operon", q: "Regulation by repressor is:", options: ["Positive regulation", "Processing-level regulation", "Post-translational regulation", "Negative regulation"], correct: 3, explanation: "Repressor inhibits transcription = negative regulation." },
    ...
    { id: 364, topic: "Lac Operon", q: "Correct sequence of lac operon components:", options: ["z → y → a → Promoter → Operator → i gene", "Promoter → i gene → z → y → a → Operator", "i gene → Promoter → Operator → z → y → a", "Operator → Promoter → i gene → a → y → z"], correct: 2, explanation: "i gene → Promoter → Operator → z → y → a." },

    { id: 365, topic: "Lac Operon", q: "Statement 1: i gene named after 'inducer'.<br>Statement 2: i gene codes for repressor protein.", options: ["Both correct", "Only S1 correct", "Both incorrect", "Only S2 correct"], correct: 3, explanation: "S1 is WRONG — i = inhibitor, NOT inducer. S2 is correct." },

    { id: 366, topic: "Lac Operon", q: "When inducer binds repressor, the repressor:", options: ["Is inactivated, can't bind operator", "Becomes more active", "Degrades structural genes", "Activates DNA polymerase"], correct: 0, explanation: "Repressor is inactivated by inducer → can't bind operator → transcription proceeds." },
    ...
    { id: 370, topic: "Lac Operon", q: "Lac operon expressed as long as:", options: ["Glucose present", "i gene is mutated", "Repressor is active", "Lactose present (as inducer)"], correct: 3, explanation: "Expressed as long as inducer (lactose) keeps repressor inactive." },

    { id: 371, topic: "Lac Operon", q: "Which is <b>incorrect</b> about lac operon?", options: ["y gene → transacetylase", "z gene → β-galactosidase", "i gene → repressor", "a gene → transacetylase"], correct: 0, explanation: "y gene → PERMEASE (not transacetylase). a gene → transacetylase." },

    { id: 372, topic: "Lac Operon", q: "If operator mutated (repressor can't bind), operon would be:", options: ["Never expressed", "Constitutively expressed (always ON)", "Only with lactose", "Produces only repressor"], correct: 1, explanation: "No repressor binding → RNA polymerase always has access → always ON." },
    ...
    { id: 374, topic: "Lac Operon", q: "Lactose present → Inducer binds repressor → Repressor _____ → RNA polymerase _____ → Genes _____", options: ["Activated → Blocked → Not transcribed", "Inactivated → Blocked → Not transcribed", "Degraded → Inhibited → Transcribed", "Inactivated → Accesses promoter → Transcribed"], correct: 3, explanation: "Inactivated → accesses promoter → transcribed." },
    ...
    { id: 378, topic: "Lac Operon", q: "Products in correct order (z, y, a):", options: ["Transacetylase, Permease, β-galactosidase", "Permease, β-galactosidase, Transacetylase", "β-galactosidase, Permease, Transacetylase", "β-galactosidase, Transacetylase, Permease"], correct: 2, explanation: "z=β-gal, y=permease, a=transacetylase." },

    { id: 379, topic: "Lac Operon", q: "Super-repressor (can't be inactivated by inducer) would make operon:", options: ["Constitutively expressed", "Expressed only without lactose", "Expressed normally", "Permanently OFF even with lactose"], correct: 3, explanation: "Super-repressor always bound to operator → permanently OFF. HOTs question." },

    { id: 380, topic: "Lac Operon", q: "<b>Incorrect</b> match:", options: ["y gene – Transacetylase", "z gene – β-galactosidase", "i gene – Repressor", "a gene – Transacetylase"], correct: 0, explanation: "y gene = PERMEASE, not transacetylase." },

    { id: 381, topic: "Lac Operon", q: "Which operon example NOT mentioned in NCERT?", options: ["lac operon", "gal operon", "ara operon", "trp operon"], correct: 1, explanation: "NCERT mentions lac, trp, ara, his, val operons. Not gal operon." },
    ...
    { id: 385, topic: "Lac Operon", q: "Correct statement about lac operon:", options: ["All 3 products needed for lactose metabolism", "Repressor produced only without lactose", "Galactose acts as inducer", "All 3 genes code for unrelated pathways"], correct: 0, explanation: "All three gene products required for metabolism of lactose." },

    { id: 386, topic: "Lac Operon", q: "Number of structural genes in lac operon:", options: ["1", "3", "2", "4"], correct: 1, explanation: "Three structural genes: z, y, a. Plus one regulatory gene (i)." },

    { id: 387, topic: "Lac Operon", q: "Conditions and operon status:<br>(i) Lactose present, glucose absent → ON<br>(ii) Lactose absent → OFF<br>(iii) Glucose present, lactose absent → ON<br>(iv) Lactose present, repressor mutated → ON<br><br>Which correct?", options: ["(i) and (iii)", "All four", "(i), (ii) and (iv) only", "(ii) and (iv) only"], correct: 2, explanation: "(iii) WRONG — no lactose = no inducer = OFF regardless of glucose." },

    { id: 388, topic: "Lac Operon", q: "'Constitutive' in context of repressor means:", options: ["Produced only with lactose", "Produced only during cell division", "Never produced", "Produced all the time regardless of conditions"], correct: 3, explanation: "Constitutive = always expressed, independent of environmental conditions." },

    // ===== SET 20: HUMAN GENOME PROJECT (Q389-Q443) =====
    { id: 389, topic: "Human Genome Project", q: "HGP launched in:", options: ["1990", "1986", "1953", "2003"], correct: 0, explanation: "Launched in 1990, completed in 2003." },
    ...
    { id: 392, topic: "Human Genome Project", q: "HGP coordinated by:", options: ["WHO and UNESCO", "Japanese Genome Institute", "Wellcome Trust and NIH only", "US DOE and NIH"], correct: 3, explanation: "US Department of Energy and National Institute of Health." },

    { id: 393, topic: "Human Genome Project", q: "New biology area closely associated with HGP:", options: ["Bioinformatics", "Proteomics", "Metabolomics", "Epigenetics"], correct: 0, explanation: "HGP closely associated with Bioinformatics." },

    { id: 394, topic: "Human Genome Project", q: "Goals of HGP:<br>(i) Identify ~20,000-25,000 genes<br>(ii) Determine 3 billion bp<br>(iii) Store in databases<br>(iv) Address ELSI<br><br>Which were goals?", options: ["(i) and (ii) only", "All of the above", "(i), (ii) and (iii)", "(i) and (iv) only"], correct: 1, explanation: "All four are explicitly stated goals." },
    ...
    { id: 397, topic: "Human Genome Project", q: "ELSI stands for:", options: ["Expressed Loci Sequence Information", "Expressed Sequence Tag Loci Identification", "Enzymatic Ligation and Sequencing Initiative", "Ethical, Legal, and Social Issues"], correct: 3, explanation: "Ethical, Legal, and Social Issues." },

    { id: 398, topic: "Human Genome Project", q: "Books needed to store human genome (1000 letters/page, 1000 pages/book):", options: ["3,300", "330", "33,000", "330,000"], correct: 0, explanation: "3.3 × 10⁹ / (1000 × 1000) = 3,300 books." },

    { id: 399, topic: "Human Genome Project", q: "NOT mentioned as model organism in NCERT:", options: ["C. elegans", "Mus musculus (mouse)", "Drosophila", "Arabidopsis"], correct: 1, explanation: "NCERT mentions bacteria, yeast, C. elegans, Drosophila, rice, Arabidopsis. Not mouse." },

    { id: 400, topic: "Human Genome Project", q: "C. elegans is:", options: ["Pathogenic bacterium", "Fruit fly", "Free-living non-pathogenic nematode", "Flowering plant"], correct: 2, explanation: "C. elegans = free living non-pathogenic nematode." },

    { id: 401, topic: "Human Genome Project", q: "Two major methodological approaches:", options: ["PCR and gel electrophoresis", "Cloning and transformation", "Restriction mapping and Southern blotting", "EST and Sequence Annotation"], correct: 3, explanation: "Expressed Sequence Tags (ESTs) and Sequence Annotation." },

    { id: 402, topic: "Human Genome Project", q: "EST refers to:", options: ["Identifying genes expressed as RNA", "All non-coding sequences", "Random genomic fragments", "Repetitive DNA sequences"], correct: 0, explanation: "EST = identifying all genes expressed as RNA." },
    ...
    { id: 404, topic: "Human Genome Project", q: "Vectors used in HGP:", options: ["Plasmids and cosmids", "Phage vectors only", "BAC and YAC", "Expression vectors only"], correct: 2, explanation: "BAC (Bacterial Artificial Chromosomes) and YAC (Yeast Artificial Chromosomes)." },

    { id: 405, topic: "Human Genome Project", q: "Common hosts for cloning in HGP:", options: ["Human cells and plants", "Viruses and algae", "Animal cells and fungi", "Bacteria and yeast"], correct: 3, explanation: "Bacteria and yeast were commonly used hosts." },

    { id: 406, topic: "Human Genome Project", q: "DNA sequencing method developed by:", options: ["Frederick Sanger", "Maxam and Gilbert", "Khorana", "Watson and Crick"], correct: 0, explanation: "Sanger developed the sequencing method. Also credited for amino acid sequencing." },
    ...
    { id: 410, topic: "Human Genome Project", q: "Total human chromosomes sequenced:", options: ["22", "23", "46", "24"], correct: 3, explanation: "24 chromosomes: 22 autosomes + X + Y." },

    { id: 411, topic: "Human Genome Project", q: "Microsatellites used in genetic mapping are:", options: ["Repetitive DNA sequences showing polymorphism", "Large coding genes", "Non-repetitive regulatory sequences", "SNPs"], correct: 0, explanation: "Repetitive DNA sequences showing polymorphism." },
    ...
    { id: 413, topic: "Human Genome Project", q: "Average gene size:", options: ["300 bases", "30,000 bases", "3,000 bases", "300,000 bases"], correct: 2, explanation: "Average gene = 3000 bases." },

    { id: 414, topic: "Human Genome Project", q: "Largest known human gene:", options: ["Insulin", "Hemoglobin", "Collagen", "Dystrophin"], correct: 3, explanation: "Dystrophin at 2.4 million bases." },

    { id: 415, topic: "Human Genome Project", q: "Total genes estimated by HGP:", options: ["30,000", "1,40,000", "80,000", "3,00,000"], correct: 0, explanation: "~30,000 genes — much lower than previous estimates." },

    { id: 416, topic: "Human Genome Project", q: "Percentage of nucleotide bases same in all humans:", options: ["90%", "99.9%", "95%", "100%"], correct: 1, explanation: "99.9% same. Only 0.1% accounts for individual differences." },
    ...
    { id: 418, topic: "Human Genome Project", q: "What % of genome codes for proteins?", options: ["More than 90%", "About 25%", "About 50%", "Less than 2%"], correct: 3, explanation: "Less than 2% codes for proteins. Over 98% is non-coding." },
    ...
    { id: 423, topic: "Human Genome Project", q: "SNPs are:", options: ["Single base DNA differences at ~1.4 million locations", "Repeated sequences (thousands of times)", "Large deletions", "Transposable element insertions"], correct: 0, explanation: "1.4 million locations of single base DNA differences." },
    ...
    { id: 425, topic: "DNA Fingerprinting", q: "What percentage of base sequences differ among humans?", options: ["0.001%", "0.1%", "0.01%", "1%"], correct: 1, explanation: "NCERT: '99.9 per cent of base sequence among humans is the same.' Therefore, 0.1% differs. With 3 × 10⁹ bp, this means approximately 3 × 10⁶ (3 million) base pairs differ between two individuals." },

    { id: 426, topic: "DNA Fingerprinting", q: "Assuming the human genome is 3 × 10⁹ bp, the number of base pair differences between two individuals would be approximately:", options: ["3 × 10³", "3 × 10⁹", "3 × 10⁶", "3 × 10⁴"], correct: 2, explanation: "0.1% of 3 × 10⁹ = 0.001 × 3 × 10⁹ = 3 × 10⁶ (3 million) base pairs. This is the basis for individual uniqueness." },

    { id: 427, topic: "DNA Fingerprinting", q: "DNA fingerprinting involves identifying differences in:", options: ["Coding sequences of DNA", "Ribosomal RNA genes", "Mitochondrial DNA only", "Repetitive DNA sequences"], correct: 3, explanation: "NCERT: 'DNA fingerprinting involves identifying differences in some specific regions in DNA sequence called as repetitive DNA, because in these sequences, a small stretch of DNA is repeated many times.'" },

    { id: 428, topic: "DNA Fingerprinting", q: "Satellite DNA is separated from bulk genomic DNA by:", options: ["Density gradient centrifugation", "Gel electrophoresis", "Paper chromatography", "PCR amplification"], correct: 0, explanation: "NCERT: 'These repetitive DNA are separated from bulk genomic DNA as different peaks during density gradient centrifugation.' The bulk DNA forms a major peak, while satellite DNA forms smaller peaks." },

    { id: 429, topic: "DNA Fingerprinting", q: "Satellite DNA is classified based on:", options: ["Only base composition", "Base composition, length of segment, and number of repetitive units", "Only the number of genes it contains", "Its location in mitochondria"], correct: 1, explanation: "NCERT: 'Depending on base composition (A:T rich or G:C rich), length of segment, and number of repetitive units, the satellite DNA is classified into many categories, such as micro-satellites, mini-satellites etc.'" },

    { id: 430, topic: "DNA Fingerprinting", q: "Consider the following about satellite DNA:<br>(i) They normally do not code for any proteins.<br>(ii) They form a large portion of the human genome.<br>(iii) They show high degree of polymorphism.<br>(iv) They code for essential enzymes.<br><br>Which are correct?", options: ["(i) and (iv) only", "(i), (ii), (iii) and (iv)", "(i), (ii) and (iii) only", "(ii) and (iii) only"], correct: 2, explanation: "Statement (iv) is INCORRECT — satellite DNA sequences 'normally do not code for any proteins.' Statements (i), (ii), and (iii) are directly from NCERT." },

    { id: 431, topic: "DNA Fingerprinting", q: "DNA fingerprinting is useful in forensic applications because:", options: ["DNA sequence varies from tissue to tissue in an individual", "DNA polymorphisms are not inheritable", "Only blood DNA can be used for fingerprinting", "DNA from every tissue of an individual shows the same degree of polymorphism"], correct: 3, explanation: "NCERT: 'Since DNA from every tissue (such as blood, hair-follicle, skin, bone, saliva, sperm etc.), from an individual show the same degree of polymorphism, they become very useful identification tool in forensic applications.'" },

    { id: 432, topic: "DNA Fingerprinting", q: "DNA fingerprinting is the basis of paternity testing because:", options: ["Polymorphisms are inheritable from parents to children", "DNA polymorphisms are not inherited", "All individuals have the same DNA fingerprint", "Paternity can only be determined by blood group analysis"], correct: 0, explanation: "NCERT: 'as the polymorphisms are inheritable from parents to children, DNA fingerprinting is the basis of paternity testing, in case of disputes.'" },
    ...
    { id: 435, topic: "DNA Fingerprinting", q: "DNA polymorphism ultimately arises due to:", options: ["Recombination only", "Transcription errors", "Mutations", "Translation errors"], correct: 2, explanation: "NCERT: 'Polymorphism (variation at genetic level) arises due to mutations.'" },

    { id: 436, topic: "DNA Fingerprinting", q: "For a germ cell mutation to spread to other members of a population, it must:", options: ["Occur in somatic cells", "Seriously impair reproductive ability", "Be lethal to the individual", "Not seriously impair the individual's ability to have offspring who can transmit the mutation"], correct: 3, explanation: "NCERT: 'If a germ cell mutation does not seriously impair individual\'s ability to have offspring who can transmit the mutation, it can spread to the other members of population (through sexual reproduction).'" },

    { id: 437, topic: "DNA Fingerprinting", q: "The technique of DNA Fingerprinting was initially developed by:", options: ["Alec Jeffreys", "Frederick Sanger", "Francis Crick", "Francois Jacob"], correct: 0, explanation: "NCERT: 'The technique of DNA Fingerprinting was initially developed by Alec Jeffreys.'" },
    ...
    { id: 439, topic: "DNA Fingerprinting", q: "VNTR belongs to a class of satellite DNA referred to as:", options: ["Microsatellite", "Macrosatellite", "Minisatellite", "Megasatellite"], correct: 2, explanation: "NCERT: 'The VNTR belongs to a class of satellite DNA referred to as mini-satellite.' This is a frequently tested NEET fact — students often confuse VNTR with microsatellite." },

    { id: 440, topic: "DNA Fingerprinting", q: "The correct sequence of steps in DNA fingerprinting is:", options: ["Isolation of DNA → Electrophoresis → Digestion by restriction endonucleases → Blotting → Hybridisation → Autoradiography", "Hybridisation → Isolation → Digestion → Electrophoresis → Blotting → Autoradiography", "Digestion → Isolation → Blotting → Electrophoresis → Hybridisation → Autoradiography", "Isolation of DNA → Digestion by restriction endonucleases → Electrophoresis → Blotting → Hybridisation → Autoradiography"], correct: 3, explanation: "NCERT lists the steps as: (i) Isolation of DNA, (ii) Digestion by restriction endonucleases, (iii) Separation by electrophoresis, (iv) Blotting (transfer to nitrocellulose/nylon membrane), (v) Hybridisation with labelled VNTR probe, (vi) Autoradiography. This exact sequence is frequently tested." },

    { id: 441, topic: "DNA Fingerprinting", q: "In DNA fingerprinting, separated DNA fragments are transferred to:", options: ["Synthetic membranes such as nitrocellulose or nylon", "Agar plates", "Glass slides", "Filter paper"], correct: 0, explanation: "NCERT: 'transferring (blotting) of separated DNA fragments to synthetic membranes, such as nitrocellulose or nylon.' This is the Southern blotting step." },

    { id: 442, topic: "DNA Fingerprinting", q: "The technique used for DNA fingerprinting involves:", options: ["Northern blot hybridisation", "Southern blot hybridisation using radiolabelled VNTR as a probe", "Western blot hybridisation", "Eastern blot hybridisation"], correct: 1, explanation: "NCERT: 'The technique...involved Southern blot hybridisation using radiolabelled VNTR as a probe.'" },

    { id: 443, topic: "DNA Fingerprinting", q: "The size of VNTR varies from:", options: ["0.01 to 2 kb", "1 to 200 kb", "0.1 to 20 kb", "10 to 2000 kb"], correct: 2, explanation: "NCERT: 'the size of VNTR varies in size from 0.1 to 20 kb.' This variation is due to different numbers of tandem repeat copies." },

    { id: 444, topic: "DNA Fingerprinting", q: "Consider the following:<br>(i) VNTR copy number varies from chromosome to chromosome in an individual.<br>(ii) The number of repeats shows a very high degree of polymorphism.<br>(iii) After hybridisation, the autoradiogram gives many bands of differing sizes.<br>(iv) The band pattern is the same for all individuals in a population.<br><br>Which are correct?", options: ["(ii) and (iii) only", "(i), (ii), (iii) and (iv)", "(i) and (iv) only", "(i), (ii) and (iii) only"], correct: 3, explanation: "Statement (iv) is INCORRECT — NCERT: 'These bands give a characteristic pattern for an individual DNA...It differs from individual to individual in a population except in the case of monozygotic (identical) twins.' Statements (i), (ii), and (iii) are correct." },

    { id: 445, topic: "DNA Fingerprinting", q: "The DNA fingerprint pattern is the same in:", options: ["Monozygotic (identical) twins", "Dizygotic (fraternal) twins", "All siblings", "Parent and offspring"], correct: 0, explanation: "NCERT: 'It differs from individual to individual in a population except in the case of monozygotic (identical) twins.' Identical twins have identical DNA, hence identical fingerprints." },
    ...
    { id: 449, topic: "DNA Fingerprinting", q: "Which of the following is the correct full form of VNTR?", options: ["Variable Nucleotide Tandem Regions", "Variable Non-coding Tandem Regions", "Very Numerous Tandem Replications", "Variable Number of Tandem Repeats"], correct: 3, explanation: "NCERT: 'It was called as Variable Number of Tandem Repeats (VNTR).'" },

    { id: 450, topic: "DNA Fingerprinting", q: "In VNTR, the term 'tandem' means:", options: ["A small DNA sequence is arranged one after another in series", "The repeats are scattered throughout the genome", "The repeats are found on only one chromosome", "The repeats are in reverse orientation"], correct: 0, explanation: "NCERT: 'A small DNA sequence is arranged tandemly in many copy numbers.' Tandem means arranged in series, one after another, in the same orientation." },

    { id: 451, topic: "DNA Fingerprinting", q: "DNA polymorphism plays a very important role in:", options: ["DNA replication only", "Evolution and speciation", "Transcription only", "Translation only"], correct: 1, explanation: "NCERT: 'For evolution and speciation, such polymorphisms play very important role.'" },

    { id: 452, topic: "DNA Fingerprinting", q: "Consider the following applications of DNA fingerprinting:<br>(i) Forensic science<br>(ii) Paternity testing<br>(iii) Determining population and genetic diversities<br>(iv) Determining the exact amino acid sequence of a protein<br><br>Which are correct?", options: ["(i) and (ii) only", "(i), (ii), (iii) and (iv)", "(i), (ii) and (iii) only", "(iv) only"], correct: 2, explanation: "Statement (iv) is INCORRECT — DNA fingerprinting determines DNA-level variations, NOT amino acid sequences of proteins. Statements (i), (ii), and (iii) are correct per NCERT." },

    { id: 453, topic: "DNA Fingerprinting", q: "Statement 1: Mutations in non-coding DNA accumulate over generations.<br>Statement 2: These accumulated mutations form one of the bases of variability/polymorphism.", options: ["Both are correct and Statement 2 explains Statement 1", "Only Statement 2 is correct", "Only Statement 1 is correct", "Both are correct but Statement 2 does not explain Statement 1"], correct: 3, explanation: "Both statements are correct per NCERT: 'These mutations keep on accumulating generation after generation, and form one of the basis of variability/polymorphism.' However, Statement 2 does not explain Statement 1 — rather it describes the consequence of accumulated mutations." },

    { id: 454, topic: "DNA Fingerprinting", q: "The bulk DNA during density gradient centrifugation forms:", options: ["A single major peak", "Multiple small peaks", "No peak at all", "Only satellite peaks"], correct: 0, explanation: "NCERT: 'The bulk DNA forms a major peak and the other small peaks are referred to as satellite DNA.'" },

    { id: 455, topic: "DNA Fingerprinting", q: "Match Column I with Column II:<br><br>Column I &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Column II<br>(i) VNTR &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (P) Developed DNA fingerprinting<br>(ii) Alec Jeffreys &nbsp;&nbsp; (Q) Minisatellite<br>(iii) Southern blot &nbsp; (R) 0.1 to 20 kb<br>(iv) VNTR size range (S) Hybridisation technique used in fingerprinting", options: ["(i)–P, (ii)–Q, (iii)–R, (iv)–S", "(i)–Q, (ii)–P, (iii)–S, (iv)–R", "(i)–R, (ii)–S, (iii)–P, (iv)–Q", "(i)–S, (ii)–R, (iii)–Q, (iv)–P"], correct: 1, explanation: "VNTR = minisatellite (Q); Alec Jeffreys = developed DNA fingerprinting (P); Southern blot = hybridisation technique (S); VNTR size = 0.1–20 kb (R)." },
    ...
    { id: 457, topic: "DNA Fingerprinting", q: "Which of the following describes the relationship between mutations and DNA polymorphism?", options: ["All mutations become polymorphisms", "Polymorphisms occur only in coding regions", "If an inheritable mutation occurs at high frequency (>0.01) in a population, it is called DNA polymorphism", "Somatic cell mutations are always transmitted to offspring"], correct: 2, explanation: "NCERT: 'if an inheritable mutation is observed in a population at high frequency, it is referred to as DNA polymorphism.' The frequency threshold is >0.01. Not all mutations become polymorphisms — only those that spread through the population." },

    { id: 458, topic: "DNA Fingerprinting", q: "Which step in DNA fingerprinting involves cutting DNA into fragments?", options: ["Electrophoresis", "Blotting", "Autoradiography", "Digestion by restriction endonucleases"], correct: 3, explanation: "Step (ii) of DNA fingerprinting as per NCERT: 'digestion of DNA by restriction endonucleases.' Restriction enzymes cut DNA at specific recognition sites, producing fragments of different sizes." },

    { id: 459, topic: "DNA Fingerprinting", q: "The final step in DNA fingerprinting that produces the visible band pattern is:", options: ["Autoradiography", "Blotting", "Hybridisation", "Electrophoresis"], correct: 0, explanation: "NCERT lists step (vi) as: 'detection of hybridised DNA fragments by autoradiography.' The autoradiogram shows bands of different sizes that form the DNA fingerprint." },

    { id: 460, topic: "DNA Fingerprinting", q: "Consider the following:<br>(i) Satellite DNA = non-coding repetitive sequences<br>(ii) VNTR = a type of microsatellite<br>(iii) DNA fingerprinting was developed by Alec Jeffreys<br>(iv) Band pattern is unique for each individual except identical twins<br><br>How many are correct?", options: ["One", "Three", "Two", "Four"], correct: 1, explanation: "Statement (ii) is INCORRECT — VNTR belongs to minisatellite class, NOT microsatellite. This is one of the most common NEET traps. Statements (i), (iii), and (iv) are correct. So 3 are correct." },

    { id: 461, topic: "DNA Fingerprinting", q: "In DNA fingerprinting, the probe used for hybridisation is:", options: ["Unlabelled genomic DNA", "mRNA", "Radiolabelled VNTR", "tRNA"], correct: 2, explanation: "NCERT: 'It involved Southern blot hybridisation using radiolabelled VNTR as a probe.'" },

    { id: 462, topic: "DNA Fingerprinting", q: "The number of VNTR copies varies:", options: ["Only between different species", "Only between parents and offspring", "Only between males and females", "From chromosome to chromosome in an individual"], correct: 3, explanation: "NCERT: 'The copy number varies from chromosome to chromosome in an individual.' This variation in copy number leads to different-sized fragments and hence different band patterns." },
    ...
    { id: 464, topic: "DNA Fingerprinting", q: "Which of the following is incorrect about DNA fingerprinting?", options: ["It works on the principle of DNA polymorphism", "It can differentiate between monozygotic twins", "VNTR shows high degree of polymorphism", "DNA from any tissue can be used"], correct: 1, explanation: "NCERT: band pattern 'differs from individual to individual except in the case of monozygotic (identical) twins.' Identical twins have identical DNA fingerprints, so DNA fingerprinting CANNOT differentiate between them." },

    // ===== TOPIC 30: COMPREHENSIVE SUMMARY-BASED MCQs (Q465–Q479) =====
    { id: 465, topic: "Chapter Summary", q: "Which of the following is the first genetic material to have evolved?", options: ["DNA", "Protein", "RNA", "Lipids"], correct: 2, explanation: "NCERT Summary: 'RNA is the first to evolve and DNA was derived from RNA.' This is the RNA World hypothesis." },

    { id: 466, topic: "Chapter Summary", q: "A segment of DNA that codes for RNA may be referred to as:", options: ["Operon", "Cistron only", "Codon", "Gene"], correct: 3, explanation: "NCERT Summary: 'A segment of DNA that codes for RNA may in a simplistic term can be referred as gene.' Note: The DNA coding for tRNA or rRNA also defines a gene." },
    ...
    { id: 471, topic: "Chapter Summary", q: "Consider the following comprehensive statements:<br>(i) DNA stores genetic information; RNA mostly helps in transfer and expression.<br>(ii) A-T pair has 2 H-bonds; G-C pair has 3 H-bonds.<br>(iii) In eukaryotes, genes are split into exons and introns.<br>(iv) There are specific tRNAs for every stop codon.<br><br>How many are correct?", options: ["One", "Two", "Four", "Three"], correct: 3, explanation: "Statement (iv) is INCORRECT — there are no tRNAs for stop codons. Stop codons are recognized by release factors. Statements (i), (ii), and (iii) are all correct per NCERT." },

    { id: 472, topic: "Chapter Summary", q: "The lac operon regulation can also be viewed as:", options: ["Regulation of enzyme synthesis by its substrate", "Regulation of DNA replication by enzymes", "Regulation of translation by ribosomes", "Regulation of splicing by snRNAs"], correct: 0, explanation: "NCERT Summary: 'this regulation can also be viewed as regulation of enzyme synthesis by its substrate.' Lactose (substrate) induces the lac operon to produce beta-galactosidase (enzyme)." },
    ...
    { id: 476, topic: "Chapter Summary", q: "Which of the following statements best summarizes the central theme of the chapter?", options: ["Proteins are the primary genetic material", "All genes are constitutively expressed", "RNA is always more stable than DNA", "DNA stores genetic information, RNA helps in its transfer and expression, and these processes are tightly regulated"], correct: 3, explanation: "NCERT Summary: 'While DNA stores genetic information, RNA mostly helps in transfer and expression of information.' The chapter covers DNA structure, replication, transcription, translation, regulation (lac operon), HGP, and DNA fingerprinting." },

    { id: 477, topic: "Chapter Summary", q: "Consider the following pairs and select the incorrect match:", options: ["VNTR – Microsatellite", "Repetitive DNA – Satellite DNA", "DNA fingerprinting – Alec Jeffreys", "Southern blotting – DNA transfer to membrane"], correct: 0, explanation: "VNTR belongs to minisatellite, NOT microsatellite. This is one of the most frequently tested traps in NEET from this chapter. All other matches are correct." },
    ...
    { id: 479, topic: "Chapter Summary", q: "Which of the following is correct about DNA fingerprinting?", options: ["VNTR is a type of microsatellite", "It can differentiate between identical twins", "It works on the principle of polymorphism in DNA sequences", "Only coding DNA shows polymorphism"], correct: 2, explanation: "NCERT Summary: 'DNA Fingerprinting...works on the principle of polymorphism in DNA sequences.' (B) is wrong — cannot differentiate identical twins. (C) is wrong — VNTR = minisatellite. (D) is wrong — non-coding DNA has higher polymorphism." },

    // ===== SET 21: GENE DEFINITION & FINE STRUCTURE (Q480-Q485) =====
    { id: 480, topic: "Gene", q: "As per NCERT, a gene is defined as:", options: ["Only the sequence of DNA that codes for a protein", "A sequence coding exclusively for mRNA", "Any stretch of DNA on a chromosome", "A segment of DNA that codes for RNA (or a polypeptide)"], correct: 3, explanation: "NCERT: 'A segment of DNA that codes for RNA may in a simplistic term be referred to as a gene.' This includes tRNA genes, rRNA genes, and protein-coding genes. The definition is broader than 'codes for protein'." },

    { id: 481, topic: "Gene", q: "Which of the following genes do NOT code for protein but still qualify as genes?", options: ["tRNA and rRNA genes", "Structural genes of trp operon", "z, y, a genes of lac operon", "i gene of lac operon"], correct: 0, explanation: "NCERT states that even segments of DNA that code for tRNA and rRNA qualify as genes. Genes don't exclusively code for proteins. The i gene, z, y, a genes all code for proteins." },

    { id: 482, topic: "Gene", q: "Which of the following statements about genes is INCORRECT?", options: ["Genes code for polypeptides", "Genes are always translated into proteins", "Genes code for rRNA", "Genes code for tRNA"], correct: 1, explanation: "Not all genes are translated — tRNA genes and rRNA genes are transcribed but NOT translated. Translation is specific to protein-coding genes. Options A, B, C are all valid gene types." },
    ...
    { id: 485, topic: "Gene Regulation", q: "Which of the following best describes the concept of 'constitutive' gene expression?", options: ["Gene expressed only in presence of inducer", "Gene expressed only in absence of repressor", "Gene expressed at all times regardless of cellular conditions", "Gene expressed only during S-phase"], correct: 2, explanation: "Constitutive expression = always ON, not regulated by inducer/repressor. The lac repressor gene (i gene) is constitutively expressed. This is fundamentally different from regulated/inducible expression." },

    // ===== SET 22: HUMAN GENOME PROJECT — DEEPER QUESTIONS (Q486-Q492) =====
    { id: 486, topic: "Human Genome Project", q: "The strategy NOT used in HGP was:", options: ["Expressed Sequence Tags (ESTs)", "Sequence Annotation", "Electrophoresis to separate DNA fragments", "Polymerase Chain Reaction (PCR)"], correct: 3, explanation: "NCERT describes ESTs (for gene identification) and sequence annotation as HGP strategies. NCERT does NOT list HGP strategy as including PCR per se (though it was used as a tool, it is not listed as a named strategy). ESTs and sequence annotation are the two explicitly named strategies in NCERT." },

    { id: 487, topic: "Human Genome Project", q: "ESTs (Expressed Sequence Tags) in HGP helped to:", options: ["Identify all genes that are expressed", "Sequence the entire genome including non-coding regions", "Map physical locations of restriction sites", "Determine amino acid sequences of proteins directly"], correct: 0, explanation: "NCERT: 'The scientists decided to sequence all the DNA including the non-coding sequences, and to find out the genes that are expressed as RNA, they make use of ESTs (Expressed Sequence Tags).' ESTs identify expressed/functional genes." },
    ...
    { id: 490, topic: "Human Genome Project", q: "Consider the following HGP findings:<br>(i) Total base pairs ~3.3 billion<br>(ii) Protein-coding genes ~30,000<br>(iii) >95% of genome is coding<br>(iv) Number of genes is ~4 times more than estimated<br><br>How many are correct?", options: ["One", "Three", "Two", "Four"], correct: 2, explanation: "(i) CORRECT — 3.3 billion bp (haploid). (ii) CORRECT — ~30,000 genes. (iii) INCORRECT — less than 2% codes for proteins; >98% is non-coding. (iv) INCORRECT — NCERT says 'the number of genes (30,000) is much less than the earlier estimates of 80,000 to 1,40,000 genes' — it is FEWER, not 4 times more. Only two (i and ii) are correct." },

    { id: 491, topic: "Human Genome Project", q: "The chromosome with the least number of genes is:", options: ["Chromosome 1", "X chromosome", "Chromosome 22", "Y chromosome"], correct: 3, explanation: "NCERT: 'Chromosome 1 has most genes (2968), and the Y has the fewest (231).' This is a direct recall fact from HGP findings. Y chromosome has the least number of genes." },
    ...
    { id: 493, topic: "DNA Fingerprinting", q: "Which of the following correctly describes a minisatellite?", options: ["Repeat unit of 10–60 bp, forming VNTRs", "Repeat unit of 1–6 bp, forming microsatellites", "A highly conserved single-copy sequence", "A coding sequence expressed in all tissues"], correct: 0, explanation: "NCERT describes VNTRs (Variable Number of Tandem Repeats) as minisatellites with repeat units of 10–60 bp. Microsatellites have smaller repeat units (1–6 bp). VNTRs = minisatellites — the classic NEET distinction." },
